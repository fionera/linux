...
static inline void __arch_decomp_setup(unsigned long arch_id)
{
	...
	do {
    	...
    	{
        	case 0:
            	uart_base = (u8 *)ISO_MISC_OFF_UART_U0RBR_THR_DLL;
            	break;
        	default:
        	case 1:
            	uart_base = (u8 *)MISC_UART_U1RBR_THR_DLL;
            	break;
    	}
...
#if 0 // remove this setting and use bootcode baudrate setting to prevent switch clock source 27MHz/98MHz will let booting log dirty
