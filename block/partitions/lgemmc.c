...
EXPORT_SYMBOL(lgemmc_get_partname);
EXPORT_SYMBOL(lgemmc_get_partsize);
EXPORT_SYMBOL(lgemmc_get_filesize);
EXPORT_SYMBOL(lgemmc_get_partoffset);
...
#ifdef CONFIG_PROC_FS
	proc_create("partinfo",0, NULL, &lgemmc_fops);
#endif
	return 1;
}
