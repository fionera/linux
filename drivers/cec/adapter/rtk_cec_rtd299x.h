...
#ifndef __RTK_RTD299X_CEC_H__
#define __RTK_RTD299X_CEC_H__
...
#define PATCH_RX_SAME_LA_ACK 0
#define PATCH_RX_DATA_PERIOD 82
#define PATCH_RX_DROP_SAME_LA_DATA 0
