...
void SetSDECInfo(Base* pBaseObj, UINT32 atp_dest)
{
    DtvCom* pDtvComObj = (DtvCom*)pBaseObj->pDerivedObj;

    pDtvComObj->m_ATPDest    = atp_dest;
    return;
}
...
UINT32 GetATPDest(Base* pBaseObj)
{
    DtvCom* pDtvComObj = (DtvCom*)pBaseObj->pDerivedObj;
    return pDtvComObj->m_ATPDest;
}
...
UINT32 SetBSRingBufPhyAddress(Base* pBaseObj, UINT32 phyAddr, UINT32 virAddr, UINT32 mapAddr, UINT32 mapSize)
{
    DtvCom* pDtvComObj = (DtvCom*)pBaseObj->pDerivedObj;
...
UINT32 SetICQRingBufPhyAddress(Base* pBaseObj, UINT32 phyAddr, UINT32 virAddr, UINT32 mapAddr, UINT32 mapSize)
{
    DtvCom* pDtvComObj = (DtvCom*)pBaseObj->pDerivedObj;
...
UINT32 SetRefClockPhyAddress(Base* pBaseObj, UINT32 phyAddr, UINT32 virAddr, UINT32 mapAddr, UINT32 mapSize)
{
    DtvCom* pDtvComObj = (DtvCom*)pBaseObj->pDerivedObj;
...
UINT32 GetBSRingBufVirAddress(Base* pBaseObj)
{
    DtvCom* pDtvComObj = (DtvCom*)pBaseObj->pDerivedObj;
    return pDtvComObj->BSRing_vir;
}

UINT32 GetICQRingBufVirAddress(Base* pBaseObj)
{
    DtvCom* pDtvComObj = (DtvCom*)pBaseObj->pDerivedObj;
    return pDtvComObj->ICQRing_vir;
}
UINT32 GetRefClockVirAddress(Base* pBaseObj)
{
    DtvCom* pDtvComObj = (DtvCom*)pBaseObj->pDerivedObj;
...
Base* new_DtvCom()
{
    ...
    pDtvComObj->GetATPDest              = GetATPDest;
