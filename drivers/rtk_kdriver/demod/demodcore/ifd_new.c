...
void drvif_ifd_set_scanchannel(StructATVModule *pAtvModule)
{
	...
	if ((pAtvModule->video_mode != m_atv_video_mode) || (pAtvModule->audio_mode  != m_atv_audio_mode) || (m_atv_scan_mode != 1)) {
...
void drvif_ifd_set_setchannel(StructATVModule *pAtvModule)
{
	...
	*/
	...
	if ((pAtvModule->video_mode != m_atv_video_mode) || (pAtvModule->audio_mode  != m_atv_audio_mode) || (m_atv_scan_mode != 0)) {
