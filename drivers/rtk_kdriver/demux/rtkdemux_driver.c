...
{
	dmx_warn(CHANNEL_UNKNOWN,"func %s, line %d, NOT implemented!!, fp= %p\n", __func__, __LINE__, filp);
	return 0;
}

int DEMUX_release(struct inode *inode, struct file *filp)
{
	dmx_function_call(CHANNEL_UNKNOWN);
...
long DEMUX_ioctl(struct file *filp, unsigned int cmd, unsigned long arg)
{
	...
	if (cmd == DEMUX_IOC_INIT || cmd == DEMUX_IOC_INIT_COMPAT) {
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_BUF_INFO_T))
			...
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_GET_BUF_INFO failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
			ret = 0;
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_STC_T))
			...
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_GET_STC failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
			ret = 0;
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_SCRAMBLE_T))) {
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_START_SCRAMBLE_CHECK failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_SCRAMBLE_T))) {
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_STOP_SCRAMBLE_CHECK failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_SCRAMBLE_T))) {
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_CHECK_SCRAMBLED_STATUS failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_SET_PID_T))) {
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_SET_PID failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_GET_PID_T))) {
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_GET_PID failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_ADD_SEC_FILTER_T))) {
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_ADD_SECTION_FILTER failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else {
		...
		if(copy_from_user((void *)&compat_data, (const void __user *)arg, sizeof(DEMUX_ADD_SEC_FILTER_COMPAT_T))){
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_ADD_SECTION_FILTER_COMPAT failed !!!!!!!!!!!!!!!\n", __LINE__);
		}
		else
		{
			...
			if (ret < 0 || copy_to_user((void __user *)arg, (void *)&compat_data, sizeof(DEMUX_ADD_SEC_FILTER_COMPAT_T))) {
				ret = -EFAULT;
				dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_ADD_SECTION_FILTER_COMAT failed !!!!!!!!!!!!!!!\n", __LINE__);
			}
		}
	}
#endif
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_CANCEL_SEC_FILTER_T))) {
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_CANCEL_SECTION_FILTER failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_ADD_PES_FILTER_T))) {
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_ADD_PES_FILTER failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else {
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_CANCEL_PES_FILTER_T))) {
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_CANCEL_PES_FILTER failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_FREE_FILTER_BUFFER_T))) {
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_FREE_FILTER_BUFFER failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_CHANNEL_T))) {
			ret = -EFAULT;
			dmx_err(data,"RTKDEMUX[%d]: ioctl DEMUX_IOC_START_PCR_RECOVERY failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else {
			dmx_dbg(data,"\033[1;36m [%s %d] DEMUX_StartPCRRecovery(%d)\033[m\n", __func__ , __LINE__ , data )
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_CHANNEL_T))) {
			ret = -EFAULT;
			dmx_err(data,"RTKDEMUX[%d]: ioctl DEMUX_IOC_STOP_PCR_RECOVERY failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else {
			dmx_dbg(data,"\033[1;36m [%s %d] DEMUX_StopPCRRecovery(%d)\033[m\n", __func__ , __LINE__ , data );
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_RESET_FILTERS_T))) {
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_RESET_FILTERS failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_INIT_DESCRAMBLER_T))) {
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_INIT_DESCRAMBLER failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_DESCRAMBLER_MODE_T))) {
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_SET_DESCRAMBLER_MODE failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_DESCRAMBLER_CWINFO_T))) {
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_GET_DESCRAMBLER_CWINFO copy data failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else{
			if (IOCTL_GetCWInfo(&data) < 0 || copy_to_user((void __user *)arg, (void *)&data, sizeof(DEMUX_DESCRAMBLER_CWINFO_T))) {
				ret = -EFAULT;
				dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_GET_DESCRAMBLER_CWINFO failed !!!!!!!!!!!!!!!\n", __LINE__);
			} else
				ret = 0;
		}
	}
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_SET_CW_T))) {
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_SET_CW failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_SET_PID_T))) {
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_GET_PID_FILTER_INDEX failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_MTP_FLUSH_T)))	{
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_MTP_FLUSH failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_PVR_BUF_INFO_T))
			...
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_MTP_GET_BUF failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
			ret = 0;
	}
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_MTP_WRITE_T))) {
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_MTP_WRITE_BUF failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_MTP_WRITE_STATUS_T))
			...
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_MTP_GET_WRITE_STATUS failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
			ret = 0;
	}
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_TIMESTAMP_SETTING_T))) {
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_SET_TIMESTAMP_PADDING failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_TP_PARAM_T))) {
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_SET_TP_PARAM failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_TP_PARAM_T))
			...
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_GET_TP_PARAM failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
			ret = 0;
	}
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_TP_SOURCE_T))) {
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_SET_TP_DATA_SOURCE failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_TP_SOURCE_T))
			...
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_GET_TP_DATA_SOURCE failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
			ret = 0;
	}
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_PRIVATE_INFO_T))) {
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_SET_PRIVATE_INFO failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_TP_STREAM_CONTROL_T))) {
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_TP_STREAM_CONTROL failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_REC_STATUS_T))) {
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_SET_RECORD_STATUS failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_MTP_STREAMING_STATUS_T))) {
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_SET_MTP_STREAMING_STATUS failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_BUF_INFO_EX_T))
			...
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_GET_BUF_INFO_CB failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
			ret = 0;
	}
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_ENABLE_DESCRAMBLER_T))) {
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_ENABLE_DESCRAMBLER failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_IS_PID_ACTIVE_T))) {
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_IS_PID_ACTIVE failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_CLEAR_DESCRAMBLER_T))) {
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_CLEAR_DESCRAMBLER failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_SWITCH_DESCRAMBLER_T))) {
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_SWITCH_DESCRAMBLER failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_SET_CI_CHANNEL_T))) {
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_SET_CI_CHANNEL failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
		...
		if (IOCTL_GetHardwareInfo(&data) < 0 || copy_to_user((void __user *)arg, (void *)&data, sizeof(DEMUX_GET_TP_HARDWARE_INFO_T))) {
			ret = -EFAULT;
			dmx_err(CHANNEL_UNKNOWN, "RTKDEMUX[%d]: ioctl DEMUX_IOC_GET_TP_HARDWARE_INFO failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
			ret = 0;
	}
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_DEBUG_INFO_T))) {
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_DEBUG_INFO failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_SET_MULTI_PID_T))) {
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_SET_PID_ACTIVE failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_SET_MULTI_PID_T))) {
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_SET_PID_MULTI failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_REMOVE_PID_T))) {
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_REMOVE_PID_MULTI failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_TP_INPUT_POL_T))) {
			ret = -EFAULT;
			dmx_err(CHANNEL_UNKNOWN, "RTKDEMUX[%d]: ioctl DEMUX_IOC_SET_TP_INPUT_POL failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_SET_TP_OUT_SOURCE_T))) {
			ret = -EFAULT;
			dmx_err(CHANNEL_UNKNOWN, "RTKDEMUX[%d]: ioctl DEMUX_IOC_SET_TP_OUT_DATA_SOURCE failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_SET_TP_OUT_STREAM_CONTROL_T))) {
			ret = -EFAULT;
			dmx_err(CHANNEL_UNKNOWN, "RTKDEMUX[%d]: ioctl DEMUX_IOC_SET_TP_OUT_STREAM_CONTROL failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_SET_TP_OUT_CLOCK_SPEED_T))) {
			ret = -EFAULT;
			dmx_err(CHANNEL_UNKNOWN, "RTKDEMUX[%d]: ioctl DEMUX_IOC_SET_TP_OUT_CLOCK_SPEED failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_FREE_DESCRAMBLE_INDEX_T))) {
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_FREE_DESCRAMBLE_INDEX failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_SET_SPEED_T))) {
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_SET_SPEED failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_TP_STATUS_T))
			...
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_GET_TP_STATUS failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
			ret = 0;
	}
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_TP_SOURCE_CONFIG_T))) {
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_SET_TP_INPUT_CONFIG failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
		...
		if (copy_from_user((void *)data, (const void __user *)arg, allocate_size)
			...
			ret = -EFAULT;
			dmx_err(CHANNEL_UNKNOWN, "RTKDEMUX[%d]: ioctl DEMUX_IOC_GET_FILTERLIST failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else {
			ret = 0;
		}
		kfree(data);
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_TP_PACKETSTATUS_T))
			...
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_GET_FILTERLIST failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
			ret = 0;
	}
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_CHANNEL_T))) {
			ret = -EFAULT;
			dmx_err(data, "RTKDEMUX[%d]: ioctl DEMUX_IOC_FREE_MTP failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
...
#else
		dmx_warn(CHANNEL_UNKNOWN, "RTKDEMUX[%d]: ioctl DEMUX_IOC_RELEASE_BUF(0x%08x)\n", __LINE__, cmd);
		ret = 0;
#endif
	}
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_PVR_BUF_INFO_T))
			...
			||  copy_to_user((void __user *)arg, (void *)&data, sizeof(DEMUX_PVR_BUF_INFO_T))) {
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_GET_INFO_BUF failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
			ret = 0;
	}
		...
		if (copy_from_user((void *)halLogBuf, (const void __user *)arg, 255)) {
			ret = -EFAULT;
			dmx_err(CHANNEL_UNKNOWN, "RTKDEMUX[%d]: ioctl DEMUX_IOC_HALLOG failed !!!!!!!!!!!!!!!\n", __LINE__);
		}
		else {
			dmx_notice(CHANNEL_UNKNOWN, "%s\n", halLogBuf);
			ret = 0;
		}
	}
	else if (cmd == DEMUX_IOC_TPP_MTP_GET_BUF || cmd == DEMUX_IOC_TPP_MTP_GET_BUF_COMPAT) {
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_TPP_MTP_BUF_INFO_T))
			...
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_TPP_MTP_GET_BUF failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
			ret = 0;
	}
	else if (cmd == DEMUX_IOC_FREE_TPP_MTP || cmd == DEMUX_IOC_FREE_TPP_MTP_COMPAT) {
		DEMUX_CHANNEL_T data;
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_CHANNEL_T))) {
			ret = -EFAULT;
			dmx_err(data, "RTKDEMUX[%d]: ioctl DEMUX_IOC_FREE_TPP_MTP failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
			ret = IOCTL_FreeTPPMTPBuf(&data);
	}
	else if (cmd == DEMUX_IOC_TPP_MTP_GET_WRITE_STATUS || cmd == DEMUX_IOC_TPP_MTP_GET_WRITE_STATUS_COMPAT) {
		DEMUX_MTP_WRITE_STATUS_T data;
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_MTP_WRITE_STATUS_T))
				||  IOCTL_TPPMTPGetWriteStatus(&data) < 0
				||  copy_to_user((void __user *)arg, (void *)&data, sizeof(DEMUX_MTP_WRITE_STATUS_T))) {
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_TPP_MTP_GET_WRITE_STATUS failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
			ret = 0;
	}
	else if (cmd == DEMUX_IOC_GET_TP_BUF_STATUS || cmd == DEMUX_IOC_GET_TP_BUF_STATUS_COMPAT) {
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_TP_BUF_STATUS_T))
			...
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_GET_TP_BUF_STATUS failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
			ret = 0;
	}
	else if (cmd == DEMUX_IOC_GET_TPP_BUF_STATUS || cmd == DEMUX_IOC_GET_TPP_BUF_STATUS_COMPAT) {
		...
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_TPP_BUF_STATUS_T))
			...
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_GET_TPP_MTP_BUF_STATUS failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
			ret = 0;
	}
	else if (cmd == DEMUX_IOC_SET_TPP_MTP_STREAMING_STATUS || cmd == DEMUX_IOC_SET_TPP_MTP_STREAMING_STATUS_COMPAT) {
		DEMUX_MTP_STREAMING_STATUS_T data;
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_MTP_STREAMING_STATUS_T))) {
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_SET_MTP_STREAMING_STATUS failed !!!!!!!!!!!!!!!\n", __LINE__);
	...
	else if (cmd == DEMUX_IOC_TPP_MTP_WRITE_BUF || cmd == DEMUX_IOC_TPP_MTP_WRITE_BUF_COMPAT) {
		DEMUX_MTP_WRITE_T data;
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_MTP_WRITE_T))) {
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_TPP_MTP_WRITE_BUF failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
			ret = IOCTL_TPPMTPWriteBuffer(&data);
	}
	else if (cmd == DEMUX_IOC_GET_CI_DL_BUF_STATUS || cmd == DEMUX_IOC_GET_CI_DL_BUF_STATUS_COMPAT) {
	...
	else if (cmd == DEMUX_IOC_SET_CI_DL_BUF_RP || cmd == DEMUX_IOC_SET_CI_DL_BUF_RP_COMPAT) {
	...
	else if (cmd == DEMUX_IOC_SET_TP_PID_FLT_EN || cmd == DEMUX_IOC_SET_TP_PID_FLT_EN_COMPAT) {
	...
	else if (cmd == DEMUX_IOC_SET_TPP_PID_FLT_EN || cmd == DEMUX_IOC_SET_TPP_PID_FLT_EN_COMPAT) {
		DEMUX_TPP_PID_ENABLE_T data;
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_TPP_PID_ENABLE_T))) {
			ret = -EFAULT;
			dmx_err(CHANNEL_UNKNOWN, "RTKDEMUX[%d]: ioctl DEMUX_IOC_TPP_MTP_WRITE_BUF failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
			ret = IOCTL_SetTppPidEnable(&data);
	}
	else if (cmd == DEMUX_IOC_SET_TP_SYNC_CP14 || cmd == DEMUX_IOC_SET_TP_SYNC_CP14_COMPAT) {
		DEMUX_TP_SYNC_CP14_T data;
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_TP_SYNC_CP14_T))) {
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_SET_TP_SYNC_CP14 failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
			ret = IOCTL_SetTpSyncCP14(&data);
	}
	else if (cmd == DEMUX_IOC_SET_BYPASS_PID_MULTI || cmd == DEMUX_IOC_SET_BYPASS_PID_MULTI_COMPAT) {
		DEMUX_PID_TABLE_T data;
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_PID_TABLE_T))) {
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_SET_BYPASS_PID_MULTI failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
			ret = IOCTL_SetBypassPIDs(&data);
	}
	else if (cmd == DEMUX_IOC_REMOVE_BYPASS_PID_MULTI || cmd == DEMUX_IOC_REMOVE_BYPASS_PID_MULTI_COMPAT) {
		DEMUX_PID_TABLE_T data;
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_PID_TABLE_T))) {
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_REMOVE_BYPASS_PID_MULTI failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
			ret = IOCTL_RemoveBypassPIDs(&data);
	}
	else if (cmd == DEMUX_IOC_GET_BYPASS_PID_MULTI || cmd == DEMUX_IOC_GET_BYPASS_PID_MULTI_COMPAT) {
		DEMUX_PID_TABLE_T data;
		if(copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_PID_TABLE_T))
				||  IOCTL_GetBypassPIDs(&data) < 0
				||  copy_to_user((void __user *)arg, (void *)&data, sizeof(DEMUX_PID_TABLE_T))){
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_GET_BYPASS_PID_MULTI failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
			ret = 0;
	}
	else if (cmd == DEMUX_IOC_TPP_MTP_FLUSH || cmd == DEMUX_IOC_TPP_MTP_FLUSH_COMPAT) {
		DEMUX_MTP_FLUSH_T data;
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_MTP_FLUSH_T)))	{
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_TPP_MTP_FLUSH failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
			ret = IOCTL_TPPMTPFlush(&data);
	}
	else if (cmd == DEMUX_IOC_TPP_FLUSH || cmd == DEMUX_IOC_TPP_FLUSH_COMPAT) {
		UINT8 data;
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(UINT8)))	{
			ret = -EFAULT;
			dmx_err(CHANNEL_UNKNOWN, "RTKDEMUX[%d]: ioctl DEMUX_IOC_TPP_FLUSH failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
			ret = IOCTL_TPPFlush(&data);
	}
	else if (cmd == DEMUX_IOC_GET_CAM_BITRATE || cmd == DEMUX_IOC_GET_CAM_BITRATE_COMPAT) {
		DEMUX_CAM_BITRATE_T data;
		if (IOCTL_GetCAMBitrate(&data) < 0
				||  copy_to_user((void __user *)arg, (void *)&data, sizeof(DEMUX_CAM_BITRATE_T))) {
			ret = -EFAULT;
			dmx_err(CHANNEL_UNKNOWN, "RTKDEMUX[%d]: ioctl DEMUX_IOC_GET_CAM_BITRATE failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
			ret = 0;
	}
	else if (cmd == DEMUX_IOC_TPP_MTP_STREAM_CONTROL || cmd == DEMUX_IOC_TPP_MTP_STREAM_CONTROL_COMPAT) {
		DEMUX_TP_STREAM_CONTROL_T data;

		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_TP_STREAM_CONTROL_T)))	{
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_TPP_STREAM_CONTROL failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
			ret = IOCTL_SetTPPMTPStreamControl(&data);
	}
#ifdef CONFIG_RTK_KDRV_ATSC3_DMX
	else if (cmd == DEMUX_IOC_DELIVERY_INIT) {
		ret = IOCTL_DeliveryINIT();
	}
	else if (cmd == DEMUX_IOC_DELIVERY_UNINIT) {
		ret = IOCTL_DeliveryUNINIT();
	}
	else if (cmd == DEMUX_IOC_DELIVERY_OPEN) {
		DEMUX_DELIVERY_CHANNEL_T data;

		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_DELIVERY_CHANNEL_T)))	{
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_DELIVERY_OPEN failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
			ret = IOCTL_DeliveryOpen(&data);
	}
	else if (cmd == DEMUX_IOC_DELIVERY_CLOSE) {
		DEMUX_DELIVERY_CHANNEL_T data;

		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_DELIVERY_CHANNEL_T)))	{
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_DELIVERY_CLOSE failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
			ret = IOCTL_DeliveryClose(&data);
	}
	else if (cmd == DEMUX_IOC_DELIVERY_SET_TP_INPUT_CONFIG) {
		DEMUX_TP_SOURCE_CONFIG_T data;
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_TP_SOURCE_CONFIG_T))) {
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_DELIVERY_SET_TP_INPUT_CONFIG failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
			ret = IOCTL_DeliverySetTPInputConfig(&data);
	}
	else if (cmd == DEMUX_IOC_DELIVERY_REQUEST_BBFRAME) {
		DEMUX_DELIVERY_CHANNEL_T data;

		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_DELIVERY_CHANNEL_T)))	{
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_DELIVERY_REQUEST_BBFRAME failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
			ret = IOCTL_DeliveryRequestBBFrame(&data);
	}
	else if (cmd == DEMUX_IOC_DELIVERY_CANCEL_BBFRAME) {
		DEMUX_DELIVERY_CHANNEL_T data;

		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_DELIVERY_CHANNEL_T)))	{
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_DELIVERY_CANCEL_BBFRAME failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
			ret = IOCTL_DeliveryCancelBBFrame(&data);
	}
	else if (cmd == DEMUX_IOC_DELIVERY_GET_BBFRAME_BUFFER) {
		DEMUX_DELIVERY_GET_BBF_BUFFER_T data;

		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_DELIVERY_GET_BBF_BUFFER_T)))
		{
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_DELIVERY_GET_BBFRAME_BUFFER failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
			ret = IOCTL_DeliveryGetBBFrameBuffer(&data);

		if (copy_to_user((void __user *)arg, (void *)&data, sizeof(DEMUX_DELIVERY_GET_BBF_BUFFER_T)))
		{
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_DELIVERY_GET_BBFRAME_BUFFER failed !!!!!!!!!!!!!!!\n", __LINE__);
			ret = -EFAULT;
		}
	}
	else if (cmd == DEMUX_IOC_DELIVERY_RETURN_BBFRAME_BUFFER) {
		DEMUX_DELIVERY_GET_BBF_BUFFER_T data;

		if(copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_DELIVERY_GET_BBF_BUFFER_T)))
		{
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_DELIVERY_RETURN_BBFRAME_BUFFER failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
		    ret = IOCTL_DeliveryReturnFrameBuffer(&data);
	}
	else if (cmd == DEMUX_IOC_DELIVERY_GET_BBFRAME_BUFF_INFO) {
		DEMUX_DELIVERY_BBF_BUFFER_INFO_T data;

		if(copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_DELIVERY_BBF_BUFFER_INFO_T)))
		{
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_DELIVERY_GET_BBFRAME_BUFF_INFO failed !!!!!!!!!!!!!!!\n", __LINE__);
			ret = -EFAULT;
		} else
			ret = IOCTL_DeliveryGetBBFrameBufferInfo(&data);

		if (copy_to_user((void __user *)arg, (void *)&data, sizeof(DEMUX_DELIVERY_BBF_BUFFER_INFO_T)))
		{
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_DELIVERY_GET_BBFRAME_BUFF_INFO failed !!!!!!!!!!!!!!!\n", __LINE__);
			ret = -EFAULT;
		}
	...
	else if (cmd == DEMUX_IOC_DELIVERY_GET_CURRENT_TIME_INFO) {
		DEMUX_DELIVERY_TIME_INFO_T data;

		if(copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_DELIVERY_TIME_INFO_T)))
		{
			dmx_err(data.ch,"RTKDEMUX[%d]: ioctl DEMUX_IOC_DELIVERY_GET_CURRENT_TIME_INFO failed !!!!!!!!!!!!!!!\n", __LINE__);
			ret = -EFAULT;
		} else
			ret = IOCTL_DeliveryGetTimeInfo(&data);

		if (copy_to_user((void __user *)arg, (void *)&data, sizeof(DEMUX_DELIVERY_TIME_INFO_T)))
		{
			dmx_err(data.ch,"RTKDEMUX[%d]: ioctl DEMUX_IOC_DELIVERY_GET_CURRENT_TIME_INFO failed !!!!!!!!!!!!!!!\n", __LINE__);
			ret = -EFAULT;
		}
	}else if (cmd == DEMUX_IOC_DELIVERY_SET_CURRENT_TIME_INFO) {
		DEMUX_DELIVERY_TIME_INFO_T data;

		if(copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_DELIVERY_TIME_INFO_T)))
		{
			dmx_err(data.ch,"RTKDEMUX[%d]: ioctl DEMUX_IOC_DELIVERY_SET_CURRENT_TIME_INFO failed !!!!!!!!!!!!!!!\n", __LINE__);
			ret = -EFAULT;
		} else
			ret = IOCTL_DeliverySetTimeInfo(&data);
	...
	}else if (cmd == DEMUX_IOC_DELIVERY_SET_SYSTEM_TIME_INFO) {
		DEMUX_DELIVERY_SYSTEM_TIME_INFO_T data;

		if(copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_DELIVERY_SYSTEM_TIME_INFO_T)))
		{
			dmx_err(data.ch,"RTKDEMUX[%d]: ioctl DEMUX_IOC_DELIVERY_SET_SYSTEM_TIME_INFO failed !!!!!!!!!!!!!!!\n", __LINE__);
			ret = -EFAULT;
		} else
			ret = IOCTL_DeliverySetSystemTimeInfo(&data);

		if (copy_to_user((void __user *)arg, (void *)&data, sizeof(DEMUX_DELIVERY_SYSTEM_TIME_INFO_T)))
		{
			dmx_err(data.ch,"RTKDEMUX[%d]: ioctl DEMUX_IOC_DELIVERY_SET_SYSTEM_TIME_INFO failed !!!!!!!!!!!!!!!\n", __LINE__);
			ret = -EFAULT;
		}
	}else if (cmd == DEMUX_IOC_DELIVERY_SET_CLOCK_RECOVERY) {
		DEMUX_DELIVERY_CLOCK_RECOVERY_T data;

		if(copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_DELIVERY_CLOCK_RECOVERY_T)))
		{
			dmx_err(data.ch,"RTKDEMUX[%d]: ioctl DEMUX_IOC_DELIVERY_SET_CLOCK_RECOVERY failed !!!!!!!!!!!!!!!\n", __LINE__);
			ret = -EFAULT;
		} else
			ret = IOCTL_DeliverySetClockRecovery(&data);

		if (copy_to_user((void __user *)arg, (void *)&data, sizeof(DEMUX_DELIVERY_CLOCK_RECOVERY_T)))
		{
			dmx_err(data.ch,"RTKDEMUX[%d]: ioctl DEMUX_IOC_DELIVERY_SET_CLOCK_RECOVERY failed !!!!!!!!!!!!!!!\n", __LINE__);
			ret = -EFAULT;
		}
	}else if (cmd == DEMUX_IOC_DELIVERY_SET_MODE) {
		DEMUX_DELIVERY_SET_MODE_T data;

		if(copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_DELIVERY_SET_MODE_T)))
		{
			dmx_err(data.ch,"RTKDEMUX[%d]: ioctl DEMUX_IOC_DELIVERY_SET_MODE failed !!!!!!!!!!!!!!!\n", __LINE__);
			ret = -EFAULT;
		} else
			ret = IOCTL_DeliverySetMode(&data);
	...
	}else if (cmd == DEMUX_IOC_DELIVERY_REQUEST_DATA) {
		DEMUX_DELIVERY_CHANNEL_T data;

		if(copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_DELIVERY_CHANNEL_T)))
		{
			dmx_err(data.ch,"RTKDEMUX[%d]: ioctl DEMUX_IOC_DELIVERY_REQUEST_DATA failed !!!!!!!!!!!!!!!\n", __LINE__);
			ret = -EFAULT;
		} else
			ret = IOCTL_DeliveryRequestData(&data);

		if (copy_to_user((void __user *)arg, (void *)&data, sizeof(DEMUX_DELIVERY_CHANNEL_T)))
		{
			dmx_err(data.ch,"RTKDEMUX[%d]: ioctl DEMUX_IOC_DELIVERY_REQUEST_DATA failed !!!!!!!!!!!!!!!\n", __LINE__);
			ret = -EFAULT;
		}
	}else if (cmd == DEMUX_IOC_DELIVERY_CANCEL_DATA) {
		DEMUX_DELIVERY_CHANNEL_T data;

		if(copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_DELIVERY_CHANNEL_T)))
		{
			dmx_err(data.ch,"RTKDEMUX[%d]: ioctl DEMUX_IOC_DELIVERY_CANCEL_DATA failed !!!!!!!!!!!!!!!\n", __LINE__);
			ret = -EFAULT;
		} else
			ret = IOCTL_DeliveryCancelData(&data);
	...
	}else if (cmd == DEMUX_IOC_DELIVERY_GET_DATA) {
		DEMUX_DELIVERY_READ_DATA_T data;
		char data_test[1024];

		if(copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_DELIVERY_READ_DATA_T)))
		{
			dmx_err(data.ch,"RTKDEMUX[%d]: ioctl DEMUX_IOC_DELIVERY_GET_DATA failed !!!!!!!!!!!!!!!\n", __LINE__);
			ret = -EFAULT;
		} else {
			if(copy_from_user((void *)data_test, (const void __user *)data.data, data.data_size))
			{
				ret = -EFAULT;
			}
			else
			{
				//dmx_err(data.ch,"DEMUX_IOC_DELIVERY_GET_DATA 0x%02x 0x%02x 0x%02x\n", data_test[0], data_test[1], data_test[2]);
				ret = 0;
			}
		}
		if (copy_to_user((void __user *)arg, (void *)&data, sizeof(DEMUX_DELIVERY_READ_DATA_T)))
		{
			dmx_err(data.ch,"RTKDEMUX[%d]: ioctl DEMUX_IOC_DELIVERY_GET_DATA failed !!!!!!!!!!!!!!!\n", __LINE__);
			ret = -EFAULT;
		}
#endif
	else if (cmd == DEMUX_IOC_VTP_VDEC_CONNECT) {
		DEMUX_VTP_VDEC_MAP_T data;
		if (copy_from_user((void*)&data, (const void __user *) arg, sizeof(DEMUX_VTP_VDEC_MAP_T))){
			dmx_err(CHANNEL_UNKNOWN, "RTKDEMUX[%d]: ioctl DEMUX_IOC_VTP_VDEC_CONNECT failed !!!!!!!!!!!!!!!\n", __LINE__);
			ret = -EFAULT;
		}else{
			ret = IOCTL_VTP_VDEC_Connect(data);
		}
	}
	else if (cmd == DEMUX_IOC_VTP_VDEC_DISCONNECT) {
		DEMUX_VTP_VDEC_MAP_T data;
		if (copy_from_user((void*)&data, (const void __user *) arg, sizeof(DEMUX_VTP_VDEC_MAP_T))){
			dmx_err(CHANNEL_UNKNOWN, "RTKDEMUX[%d]: ioctl DEMUX_IOC_VTP_VDEC_DISCONNECT failed !!!!!!!!!!!!!!!\n", __LINE__);
			ret = -EFAULT;
		}else{
			ret = IOCTL_VTP_VDEC_Disconnect(data);
		}
	}
	else{
		dmx_warn(CHANNEL_UNKNOWN, "RTKDEMUX: unknown ioctl(0x%08x)\n", cmd);
	}
	up(&demux_device->sem);
	return ret;
}
...
long DEMUX_ioctl(struct file *filp, unsigned int cmd, unsigned long arg)
{
	...
	case DEMUX_IOC_SET_TP_INPUT_POL:
		{
			...
			if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_TP_INPUT_POL_T))) {
				ret = -EFAULT;
				dmx_err(data.tpi, "RTKDEMUX[%d]: ioctl DEMUX_IOC_SET_TP_INPUT_POL failed !!!!!!!!!!!!!!!\n", __LINE__);
			} else
				ret = IOCTL_SetInputSourcePol(&data);
			break;
		}
	...
	case DEMUX_IOC_SET_TP_OUT_DATA_SOURCE:
		{
			...
			if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_SET_TP_OUT_SOURCE_T))) {
				ret = -EFAULT;
				dmx_err(data.tpout_id, "RTKDEMUX[%d]: ioctl DEMUX_IOC_SET_TP_OUT_DATA_SOURCE failed !!!!!!!!!!!!!!!\n", __LINE__);
			} else
				ret = IOCTL_SetTPOutDataSource(&data);
			break;
		}
	case DEMUX_IOC_SET_TP_OUT_STREAM_CONTROL:
		{
			...
			if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_SET_TP_OUT_STREAM_CONTROL_T))) {
				ret = -EFAULT;
				dmx_err(data.tpout_id, "RTKDEMUX[%d]: ioctl DEMUX_IOC_SET_TP_OUT_STREAM_CONTROL failed !!!!!!!!!!!!!!!\n", __LINE__);
			} else
				ret = IOCTL_SetTPOutStreamControl(&data);
			break;
		}
	case DEMUX_IOC_SET_TP_OUT_CLOCK_SPEED:
		{
			...
			if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_SET_TP_OUT_CLOCK_SPEED_T))) {
				ret = -EFAULT;
				dmx_err(data.tpout_id, "RTKDEMUX[%d]: ioctl DEMUX_IOC_SET_TP_OUT_CLOCK_SPEED failed !!!!!!!!!!!!!!!\n", __LINE__);
			} else
				ret = IOCTL_SetTPOutClockSpeed(&data);
			break;
		}
	...
	case DEMUX_IOC_TPP_MTP_STREAM_CONTROL:
	{
		DEMUX_TP_STREAM_CONTROL_T data;

		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_TP_STREAM_CONTROL_T)))	{
			ret = -EFAULT;
			dmx_err(data.ch, "RTKDEMUX[%d]: ioctl DEMUX_IOC_TPP_MTP_STREAM_CONTROL failed !!!!!!!!!!!!!!!\n", __LINE__);
		} else
			ret = IOCTL_SetTPPMTPStreamControl(&data);
		break;
	}
#ifdef CONFIG_RTK_KDRV_ATSC3_DMX
	case DEMUX_IOC_DELIVERY_INIT:
	{
		ret = IOCTL_DeliveryINIT();
		break;
	}
	case DEMUX_IOC_DELIVERY_UNINIT:
	{
		ret = IOCTL_DeliveryUNINIT();
		break;
	}
	case DEMUX_IOC_DELIVERY_OPEN:
	{
		DEMUX_DELIVERY_CHANNEL_T data;
	...
	case DEMUX_IOC_DELIVERY_SET_TP_INPUT_CONFIG:
	{
		DEMUX_TP_SOURCE_CONFIG_T data;
		if (copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_TP_SOURCE_CONFIG_T))) {
			ret = -EFAULT;
	...
	case DEMUX_IOC_DELIVERY_REQUEST_BBFRAME:
	{
		DEMUX_DELIVERY_CHANNEL_T data;
	...
	case DEMUX_IOC_DELIVERY_CANCEL_BBFRAME:
	{
		DEMUX_DELIVERY_CHANNEL_T data;
	...
	case DEMUX_IOC_DELIVERY_GET_BBFRAME_BUFFER:
	{
		DEMUX_DELIVERY_GET_BBF_BUFFER_T data;
	...
	case DEMUX_IOC_DELIVERY_RETURN_BBFRAME_BUFFER:
	{
		DEMUX_DELIVERY_GET_BBF_BUFFER_T data;
	...
	case DEMUX_IOC_DELIVERY_GET_BBFRAME_BUFF_INFO:
	{
		DEMUX_DELIVERY_BBF_BUFFER_INFO_T data;
	...
	case DEMUX_IOC_DELIVERY_GET_CURRENT_TIME_INFO:
	{
		DEMUX_DELIVERY_TIME_INFO_T data;
	...
	case DEMUX_IOC_DELIVERY_SET_CURRENT_TIME_INFO:
	{
		DEMUX_DELIVERY_TIME_INFO_T data;
	...
	case DEMUX_IOC_DELIVERY_SET_SYSTEM_TIME_INFO:
	{
		DEMUX_DELIVERY_SYSTEM_TIME_INFO_T data;
	...
	case DEMUX_IOC_DELIVERY_SET_CLOCK_RECOVERY:
	{
		DEMUX_DELIVERY_CLOCK_RECOVERY_T data;
	...
	case DEMUX_IOC_DELIVERY_SET_MODE:
	{
		DEMUX_DELIVERY_SET_MODE_T data;
		...
		if (copy_to_user((void __user *)arg, (void *)&data, sizeof(DEMUX_DELIVERY_SET_MODE_T)))
		{
			dmx_err(data.ch,"RTKDEMUX[%d]: ioctl DEMUX_IOC_DELIVERY_SET_MODE failed !!!!!!!!!!!!!!!\n", __LINE__);
			ret = -EFAULT;
		}
	...
	case DEMUX_IOC_DELIVERY_REQUEST_DATA:
	{
		DEMUX_DELIVERY_CHANNEL_T data;
	...
	case DEMUX_IOC_DELIVERY_CANCEL_DATA:
	{
		DEMUX_DELIVERY_CHANNEL_T data;
	...
	case DEMUX_IOC_DELIVERY_GET_DATA:
	{
		DEMUX_DELIVERY_READ_DATA_T data;
		if(copy_from_user((void *)&data, (const void __user *)arg, sizeof(DEMUX_DELIVERY_READ_DATA_T)))
		{
		...
		{
			ret = IOCTL_DeliveryGetData(&data);
		}
...
#endif
	case DEMUX_IOC_VTP_VDEC_CONNECT :
	{
		DEMUX_VTP_VDEC_MAP_T data;
		if (copy_from_user((void*)&data, (const void __user *) arg, sizeof(DEMUX_VTP_VDEC_MAP_T))){
			dmx_err(CHANNEL_UNKNOWN, "RTKDEMUX[%d]: ioctl DEMUX_IOC_VTP_VDEC_CONNECT failed !!!!!!!!!!!!!!!\n", __LINE__);
	...
	case DEMUX_IOC_VTP_VDEC_DISCONNECT:
	{
		DEMUX_VTP_VDEC_MAP_T data;
		if (copy_from_user((void*)&data, (const void __user *) arg, sizeof(DEMUX_VTP_VDEC_MAP_T))){
			dmx_err(CHANNEL_UNKNOWN, "RTKDEMUX[%d]: ioctl DEMUX_IOC_VTP_VDEC_DISCONNECT failed !!!!!!!!!!!!!!!\n", __LINE__);
	...
	case DEMUX_IOC_DDR_PROTEC:
	{
		DEMUX_DDR_PROTECT data;
		if (copy_from_user((void*)&data, (const void __user *) arg, sizeof(DEMUX_DDR_PROTECT))){
			dmx_err(CHANNEL_UNKNOWN, "RTKDEMUX[%d]: ioctl DEMUX_IOC_DDR_PROTEC failed !!!!!!!!!!!!!!!\n", __LINE__);
			ret = -EFAULT;
		}else{
			ret = IOCTL_SetDDRProtect(&data);
		}
		break;
	}
