...
typedef struct {
	...
	UINT32 phyRead;
	UINT32 phyWrite;
} DEMUX_CI_DL_BUF_STATUS_T;

typedef struct {
	DEMUX_CHANNEL_T ch;
	UINT32 phyRead;
} DEMUX_CI_DL_BUF_RP_T;

typedef struct {
	DEMUX_CHANNEL_T ch;
	BOOL bEnable;
} DEMUX_TP_PID_ENABLE_T;

typedef struct {
	UINT8 tpp_id;
	BOOL bEnable;
} DEMUX_TPP_PID_ENABLE_T;

typedef struct {
	DEMUX_CHANNEL_T ch;
	UINT8 u8SyncByte;
} DEMUX_TP_SYNC_CP14_T;
...
typedef struct {
  UINT8 isACON;
} DEMUX_DELIVERY_GET_BOOT_STATUS_T;

typedef struct{
  UINT8 vtp_port;
  UINT8 vdec_port;
} DEMUX_VTP_VDEC_MAP_T;
...
#define DEMUX_IOC_TPP_MTP_GET_BUF               (_IOWR(DEMUX_IOC_MAGIC, 66, DEMUX_TPP_MTP_BUF_INFO_T*))
#define DEMUX_IOC_TPP_MTP_GET_BUF_COMPAT        (_IOR (DEMUX_IOC_MAGIC,66, u32))

#define DEMUX_IOC_FREE_TPP_MTP                  (_IOR (DEMUX_IOC_MAGIC, 67, DEMUX_CHANNEL_T*))
#define DEMUX_IOC_FREE_TPP_MTP_COMPAT           (_IOR (DEMUX_IOC_MAGIC,67, u32))

#define DEMUX_IOC_TPP_MTP_GET_WRITE_STATUS          (_IOWR(DEMUX_IOC_MAGIC, 68, DEMUX_MTP_WRITE_STATUS_T*))
#define DEMUX_IOC_TPP_MTP_GET_WRITE_STATUS_COMPAT   (_IOR (DEMUX_IOC_MAGIC,68, u32))

#define DEMUX_IOC_GET_TP_BUF_STATUS             (_IOWR(DEMUX_IOC_MAGIC, 69, DEMUX_TP_BUF_STATUS_T*))
#define DEMUX_IOC_GET_TP_BUF_STATUS_COMPAT      (_IOR (DEMUX_IOC_MAGIC,69, u32))

#define DEMUX_IOC_GET_TPP_BUF_STATUS            (_IOWR(DEMUX_IOC_MAGIC, 70, DEMUX_TPP_BUF_STATUS_T*))
#define DEMUX_IOC_GET_TPP_BUF_STATUS_COMPAT     (_IOR (DEMUX_IOC_MAGIC,70, u32))

#define DEMUX_IOC_SET_TPP_MTP_STREAMING_STATUS  		(_IOR (DEMUX_IOC_MAGIC, 71, DEMUX_MTP_STREAMING_STATUS_T*))
#define DEMUX_IOC_SET_TPP_MTP_STREAMING_STATUS_COMPAT  	(_IOR (DEMUX_IOC_MAGIC,71, u32))

#define DEMUX_IOC_TPP_MTP_WRITE_BUF             (_IOR (DEMUX_IOC_MAGIC, 72, DEMUX_MTP_WRITE_T*))
#define DEMUX_IOC_TPP_MTP_WRITE_BUF_COMPAT      (_IOR (DEMUX_IOC_MAGIC,72, u32))

#define DEMUX_IOC_GET_CI_DL_BUF_STATUS          (_IOWR (DEMUX_IOC_MAGIC, 73, DEMUX_CI_DL_BUF_STATUS_T*))
#define DEMUX_IOC_GET_CI_DL_BUF_STATUS_COMPAT   (_IOR (DEMUX_IOC_MAGIC,73, u32))

#define DEMUX_IOC_SET_CI_DL_BUF_RP              (_IOR (DEMUX_IOC_MAGIC, 74, DEMUX_CI_DL_BUF_RP_T*))
#define DEMUX_IOC_SET_CI_DL_BUF_RP_COMPAT       (_IOR (DEMUX_IOC_MAGIC,74, u32))

#define DEMUX_IOC_SET_TP_PID_FLT_EN             (_IOR (DEMUX_IOC_MAGIC, 75, DEMUX_TP_PID_ENABLE_T*))
#define DEMUX_IOC_SET_TP_PID_FLT_EN_COMPAT      (_IOR (DEMUX_IOC_MAGIC,75, u32))

#define DEMUX_IOC_SET_TPP_PID_FLT_EN            (_IOR (DEMUX_IOC_MAGIC, 76, DEMUX_TPP_PID_ENABLE_T*))
#define DEMUX_IOC_SET_TPP_PID_FLT_EN_COMPAT     (_IOR (DEMUX_IOC_MAGIC,76, u32))

#define DEMUX_IOC_SET_TP_SYNC_CP14              (_IOR (DEMUX_IOC_MAGIC, 77, DEMUX_TP_SYNC_CP14_T*))
#define DEMUX_IOC_SET_TP_SYNC_CP14_COMPAT       (_IOR (DEMUX_IOC_MAGIC,77, u32))

#define DEMUX_IOC_SET_BYPASS_PID_MULTI          (_IOR (DEMUX_IOC_MAGIC, 78, DEMUX_PID_TABLE_T*))
#define DEMUX_IOC_SET_BYPASS_PID_MULTI_COMPAT   (_IOR (DEMUX_IOC_MAGIC,78, u32))

#define DEMUX_IOC_REMOVE_BYPASS_PID_MULTI          (_IOR (DEMUX_IOC_MAGIC, 79, DEMUX_PID_TABLE_T*))
#define DEMUX_IOC_REMOVE_BYPASS_PID_MULTI_COMPAT   (_IOR (DEMUX_IOC_MAGIC,79, u32))

#define DEMUX_IOC_GET_BYPASS_PID_MULTI          (_IOWR (DEMUX_IOC_MAGIC, 80, DEMUX_PID_TABLE_T*))
#define DEMUX_IOC_GET_BYPASS_PID_MULTI_COMPAT   (_IOR (DEMUX_IOC_MAGIC,80, u32))

#define DEMUX_IOC_TPP_MTP_FLUSH                 (_IOR (DEMUX_IOC_MAGIC, 81, DEMUX_MTP_FLUSH_T*))
#define DEMUX_IOC_TPP_MTP_FLUSH_COMPAT          (_IOR (DEMUX_IOC_MAGIC,81, u32))

#define DEMUX_IOC_TPP_FLUSH                     (_IOR (DEMUX_IOC_MAGIC, 82, UINT8*))
#define DEMUX_IOC_TPP_FLUSH_COMPAT              (_IOR (DEMUX_IOC_MAGIC,82, u32))

#define DEMUX_IOC_GET_CAM_BITRATE               (_IOWR (DEMUX_IOC_MAGIC, 83, DEMUX_CAM_BITRATE_T*))
#define DEMUX_IOC_GET_CAM_BITRATE_COMPAT        (_IOR (DEMUX_IOC_MAGIC,83, u32))

#define DEMUX_IOC_TPP_MTP_STREAM_CONTROL            (_IOR (DEMUX_IOC_MAGIC, 84, DEMUX_TP_STREAM_CONTROL_T*))
#define DEMUX_IOC_TPP_MTP_STREAM_CONTROL_COMPAT     (_IOR (DEMUX_IOC_MAGIC,84, u32))

#define DEMUX_IOC_DELIVERY_INIT                  (_IOWR(DEMUX_IOC_MAGIC, 85, int))
#define DEMUX_IOC_DELIVERY_UNINIT                (_IOR (DEMUX_IOC_MAGIC, 86, int))
#define DEMUX_IOC_DELIVERY_OPEN                  (_IOWR(DEMUX_IOC_MAGIC, 87, DEMUX_DELIVERY_CHANNEL_T))
#define DEMUX_IOC_DELIVERY_CLOSE                 (_IOR (DEMUX_IOC_MAGIC, 88, DEMUX_DELIVERY_CHANNEL_T))
#define DEMUX_IOC_DELIVERY_SET_TP_INPUT_CONFIG   (_IOR (DEMUX_IOC_MAGIC, 89, DEMUX_TP_SOURCE_CONFIG_T))
#define DEMUX_IOC_DELIVERY_REQUEST_BBFRAME       (_IOR (DEMUX_IOC_MAGIC, 90, DEMUX_DELIVERY_CHANNEL_T))
#define DEMUX_IOC_DELIVERY_CANCEL_BBFRAME        (_IOR (DEMUX_IOC_MAGIC, 91, DEMUX_DELIVERY_CHANNEL_T))
#define DEMUX_IOC_DELIVERY_GET_BBFRAME_BUFFER    (_IOR (DEMUX_IOC_MAGIC, 92, DEMUX_DELIVERY_GET_BBF_BUFFER_T))
#define DEMUX_IOC_DELIVERY_RETURN_BBFRAME_BUFFER (_IOR (DEMUX_IOC_MAGIC, 93, DEMUX_DELIVERY_GET_BBF_BUFFER_T))
#define DEMUX_IOC_DELIVERY_GET_BBFRAME_BUFF_INFO (_IOR (DEMUX_IOC_MAGIC, 94, DEMUX_DELIVERY_BBF_BUFFER_INFO_T))
#define DEMUX_IOC_VTP_VDEC_CONNECT               (_IOR (DEMUX_IOC_MAGIC, 95, DEMUX_VTP_VDEC_MAP_T))
#define DEMUX_IOC_VTP_VDEC_DISCONNECT            (_IOR (DEMUX_IOC_MAGIC, 96, DEMUX_VTP_VDEC_MAP_T))

#define DEMUX_IOC_DELIVERY_GET_CURRENT_TIME_INFO (_IOR (DEMUX_IOC_MAGIC, 97, DEMUX_DELIVERY_TIME_INFO_T))
#define DEMUX_IOC_DELIVERY_SET_CURRENT_TIME_INFO (_IOR (DEMUX_IOC_MAGIC, 98, DEMUX_DELIVERY_TIME_INFO_T))
#define DEMUX_IOC_DELIVERY_SET_SYSTEM_TIME_INFO  (_IOR (DEMUX_IOC_MAGIC, 99, DEMUX_DELIVERY_SYSTEM_TIME_INFO_T))
#define DEMUX_IOC_DELIVERY_SET_CLOCK_RECOVERY    (_IOR (DEMUX_IOC_MAGIC, 100, DEMUX_DELIVERY_CLOCK_RECOVERY_T))

#define DEMUX_IOC_DELIVERY_SET_MODE              (_IOR  (DEMUX_IOC_MAGIC, 101, DEMUX_DELIVERY_SET_MODE_T))
#define DEMUX_IOC_DELIVERY_REQUEST_DATA          (_IOR  (DEMUX_IOC_MAGIC, 102, DEMUX_DELIVERY_CHANNEL_T))
#define DEMUX_IOC_DELIVERY_CANCEL_DATA           (_IOR  (DEMUX_IOC_MAGIC, 103, DEMUX_DELIVERY_CHANNEL_T))
#define DEMUX_IOC_DELIVERY_GET_DATA              (_IOWR (DEMUX_IOC_MAGIC, 104, DEMUX_DELIVERY_READ_DATA_T))
#define DEMUX_IOC_DDR_PROTEC                     (_IOWR (DEMUX_IOC_MAGIC, 105, DEMUX_DDR_PROTECT))

//#define DEMUX_IOC_DELIVERY_GET_BOOT_STATUS       (_IOWR (DEMUX_IOC_MAGIC, 106, DEMUX_DELIVERY_GET_BOOT_STATUS_T))

#define DEMUX_IOC_MAXNR           107
