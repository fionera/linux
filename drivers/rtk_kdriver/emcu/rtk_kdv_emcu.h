...
#define SHT_RENO_LSADC         (0)
#define SHT_RENO_GPI            (2)   //for WOL/WOV
#define SHT_RENO_GPO            (5)   //for power enable pin
#define SHT_RENO_IRDA           (8)
#define SHT_RENO_IRDA_PT1       (14)
#define SHT_RENO_IRDA_PT2       (18)
#define SHT_RENO_STM            (22)
#define SHT_RENO_WOL            (23)
#define SHT_RENO_CEC            (24)
#define SHT_RENO_WOV            (25)
#define SHT_RENO_WUT            (26)    //wakeup from timerm bit[28/27/26]

#define RENO_LSADC_MASK        (0x3U<<SHT_RENO_LSADC)
#define RENO_GPI_MASK           (0x7U<<SHT_RENO_GPI)   //for WOL/WOV
#define RENO_GPO_MASK           (0x7U<<SHT_RENO_GPO)   //for power enable pin
#define RENO_IRDA_MASK          (0x3FU<SHT_RENO_IRDA)
#define RENO_IRDA_PT1_MASK      (0xFU<<SHT_RENO_IRDA_PT1)
#define RENO_IRDA_PT2_MASK      (0xFU<<SHT_RENO_IRDA_PT2)
#define RENO_STM_MASK           (0x1U<<SHT_RENO_STM)
#define RENO_WOL_MASK           (0x1U<<SHT_RENO_WOL)
#define RENO_CEC_MASK           (0x1U<<SHT_RENO_CEC)
#define RENO_WOV_MASK           (0x1U<<SHT_RENO_WOV)
#define RENO_WUT_MASK           (0x7U<<SHT_RENO_WUT)

//#define RTD_SHARE_MEM_BASE
//#define IDX_REG_INDEX           (0)     //reg0 for index same with Pub
#define IDX_REG_LSADC           (RTD_SHARE_MEM_BASE+(4*1))     //reg1
#define IDX_REG_GPI             (RTD_SHARE_MEM_BASE+(4*2))     //reg2
#define IDX_REG_GPO             (RTD_SHARE_MEM_BASE+(4*3))     //reg3
#define IDX_REG_IRDA_KEY        (RTD_SHARE_MEM_BASE+(4*4))     //reg4~19
#define IDX_REG_IRDA_PT         (RTD_SHARE_MEM_BASE+(4*20))    //reg20~27
#define RESERVED_1              (RTD_SHARE_MEM_BASE+(4*28))    //reg28
#define RESERVED_2              (RTD_SHARE_MEM_BASE+(4*29))    //reg29
#define RESERVED_3              (RTD_SHARE_MEM_BASE+(4*30))    //reg30
#define RESERVED_4              (RTD_SHARE_MEM_BASE+(4*31))    //reg31
