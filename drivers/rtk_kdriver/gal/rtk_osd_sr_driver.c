...
extern CONFIG_OSDSHIFT_UPSCALE_STRUCT g_osdshift_upscale_ctrl;
		...
		//	return -1;
...
#if defined(CONFIG_ARCH_RTK288O)
			/* OSD bypass need enable identity_en bit */
            ...
            if (g_osdshift_upscale_ctrl.apply_enable
			  && disPlane == (GDMA_DISPLAY_PLANE)g_osdshift_upscale_ctrl.plane) {
				osd_sr_scaleup_ctrl0_reg.ver_ini = g_osdshift_upscale_ctrl.apply_ver_ini;
				osd_sr_scaleup_ctrl0_reg.ver_factor = g_osdshift_upscale_ctrl.apply_ver_factor;
				pReg->osd_sr_scaleup_ctrl0_reg.regValue = osd_sr_scaleup_ctrl0_reg.regValue;
				
				osd_sr_scaleup_ctrl1_reg.hor_ini = g_osdshift_upscale_ctrl.apply_hor_ini;
				osd_sr_scaleup_ctrl1_reg.hor_factor = g_osdshift_upscale_ctrl.apply_hor_factor;
				pReg->osd_sr_scaleup_ctrl1_reg.regValue = osd_sr_scaleup_ctrl1_reg.regValue;				
