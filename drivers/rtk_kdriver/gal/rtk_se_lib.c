	...
	void*			pExtraParam)
{
	...
	//printk("\n pEx->src1_format=%x pEx->result_format=%x \n ",pEx->src1_format,pEx->result_format);
...
)
{
	...
	SeCmdMirror.Word7.Reserved = SEINFO_OPCODE_NOP;
	SeCmdMirror.Word8.Reserved = SEINFO_OPCODE_NOP;
