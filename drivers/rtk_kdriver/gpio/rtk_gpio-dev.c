                           ...
                           unsigned int cmd, unsigned long arg)
{
    ...
    RTK_GPIO_GET_ALL_GPIO_PIN_T *gpio_all_gpio_pin = NULL;
    ...
    switch (cmd) {
        ...
        case RTK_GPIO_GET_IRQ_FLAG:
            ...
            ret = rtk_gpio_get_irq_flag_ex(pinInfo.gid, 0);
        ...
        case RTK_GPIO_GET_ALL_GPIO_PIN:
            gpio_all_gpio_pin = (RTK_GPIO_GET_ALL_GPIO_PIN_T *)kmalloc(sizeof(RTK_GPIO_GET_ALL_GPIO_PIN_T),GFP_KERNEL);
            if(gpio_all_gpio_pin == NULL) {
                kfree(gpio_all_gpio_pin);
                return -EFAULT;
            }
