...
/*#define RTK_I2C_SCPU_INT_EN                 INTERRUPT_ISO_MISC_OFF_INT_EN_VADDR*/
#define RTK_I2C_ISO_I2C0_shift        (1)
#define RTK_I2C_ISO_I2C5_shift        (0)

#define RTK_I2C_SCPU_INT_EN               INT_CTRL_SCPU_reg
#define RTK_I2C_SCPU_INT_EN_I2C0_shift    INT_CTRL_SCPU_standby_iso_misc_off_int_scpu_routing_en_shift
#define RTK_I2C_SCPU_INT_EN_I2C5_shift    INT_CTRL_SCPU_standby_iso_misc_off_int_scpu_routing_en_shift
...
#define RTK_I2C_MIS_SCPU_INT_EN        INT_CTRL_SCPU_reg
#define RTK_I2C_MIS_SCPU_INT_EN_I2C1_shift \
    INT_CTRL_SCPU_standby_iso_misc_int_scpu_routing_en_shift
#define RTK_I2C_MIS_SCPU_INT_EN_I2C2_shift \
    INT_CTRL_SCPU_standby_iso_misc_int_scpu_routing_en_shift
#define RTK_I2C_MIS_SCPU_INT_EN_I2C3_shift \
    INT_CTRL_SCPU_standby_iso_misc_int_scpu_routing_en_shift
#define RTK_I2C_MIS_SCPU_INT_EN_I2C4_shift \
    INT_CTRL_SCPU_standby_iso_misc_int_scpu_routing_en_shift
...
static rtk_i2c_init_reg RTK_I2C_i2c0_init_reg[] =
{
    ...
    {
        RTK_I2C_SCPU_INT_EN, (~0),
        (0x1 << RTK_I2C_SCPU_INT_EN_I2C0_shift) | (1 << INT_CTRL_SCPU_INT_EN_WRITE_DATA)
    },
};
...
static rtk_i2c_init_reg RTK_I2C_i2c1_init_reg[] =
{
    ...
    {
        RTK_I2C_MIS_SCPU_INT_EN, (~0),
        (0x1 << RTK_I2C_MIS_SCPU_INT_EN_I2C1_shift) | (1 << INT_CTRL_SCPU_INT_EN_WRITE_DATA)
    },
};
...
static rtk_i2c_init_reg RTK_I2C_i2c2_init_reg[] =
{
    ...
    {
        RTK_I2C_MIS_SCPU_INT_EN, (~0),
        (0x1 << RTK_I2C_MIS_SCPU_INT_EN_I2C2_shift) | (1 << INT_CTRL_SCPU_INT_EN_WRITE_DATA)
    },
};
...
static rtk_i2c_init_reg RTK_I2C_i2c3_init_reg[] =
{
    ...
    {
        RTK_I2C_MIS_SCPU_INT_EN, (~0),
        (0x1 << RTK_I2C_MIS_SCPU_INT_EN_I2C3_shift) | (1 << INT_CTRL_SCPU_INT_EN_WRITE_DATA)
    },
};
...
static rtk_i2c_init_reg RTK_I2C_i2c4_init_reg[] =
{
    ...
    {
        RTK_I2C_MIS_SCPU_INT_EN, (~0),
        (0x1 << RTK_I2C_MIS_SCPU_INT_EN_I2C4_shift) | (1 << INT_CTRL_SCPU_INT_EN_WRITE_DATA)
    },
};
...
static rtk_i2c_init_reg RTK_I2C_i2c5_init_reg[] =
{
    ...
    {
        RTK_I2C_SCPU_INT_EN, (~0),
        (0x1 << RTK_I2C_SCPU_INT_EN_I2C5_shift) | (1 << INT_CTRL_SCPU_INT_EN_WRITE_DATA)
    },
};
