...
#define SET_I2C_SCPU_INT_EN(x)          wr_reg(RTK_ISO_MISC_OFF_SYSTEM,(rd_reg(RTK_ISO_MISC_OFF_SYSTEM) | x))
...
{ \
    ...
    {   \
        rtd_printk(KERN_INFO,  "I2C" , "[Info]" fmt, ## args); \
    }   \
}
...
{ \
    if (I2C_error_log_onoff)  \
    {   \
        rtd_printk(KERN_WARNING,  "I2C" , "[Warn]" fmt, ## args); \
    }   \
}
...
{ \
    if (I2C_error_log_onoff)  \
    {   \
        rtd_printk(KERN_DEBUG,  "I2C" , "[Debug]" fmt, ## args); \
    }   \
}
