...
typedef enum {
	...
	GDMA_DBG_CMD_SET_SHIFT_UPSCALE = 2,
	GDMA_DBG_CMD_OSD_DUMP = 3,
	GDMA_DBG_CMD_OSD_DUMP_EX = 4,
	GDMA_DBG_CMD_OSD_DROP = 5,
	GDMA_DBG_CMD_OSD_PATTERN = 6,
	GDMA_DBG_CMD_OSD_VFLIP = 7,
	GDMA_DBG_CMD_OSD_CTRL = 8,
	GDMA_DBG_CMD_OSD_SWAP = 9,
	GDMA_DBG_CMD_OSD_CAP2MEM = 10,
	GDMA_DBG_CMD_SHOW_INFO = 11,
	GDMA_DBG_CMD_OSD_GET_INFO = 12,
	GDMA_DBG_CMD_OSD_CTRL_EN = 13,
	GDMA_DBG_CMD_SE_FILM = 14,
	GDMA_DBG_CMD_SHOW_INT_STATUS = 15,
	GDMA_DBG_CMD_OSD_CLONE_EN = 16,
	GDMA_DBG_CMD_OSD_BW_GEN_EN = 17,
	GDMA_DBG_CMD_OSD_GAL_SURFACE_INFO = 18,
	GDMA_DBG_CMD_OSD_GAL_AI_BLOCK = 19,
	GDMA_DBG_CMD_OSD_GET_GOLBAL_ALPHA = 20,
	GDMA_DBG_CMD_OSD_SET_OSD_GAIN = 21,
	GDMA_DBG_CMD_NUMBER
