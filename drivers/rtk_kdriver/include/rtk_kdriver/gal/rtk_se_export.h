...
typedef struct _SECMD_EXD_FMT_CONV_FILM
{
	...
	struct
	{
		UINT32	src2_c2_addr_index: 7;
		UINT32	Reserved4: 1;
		UINT32	src2_c1_addr_index: 7;
		UINT32	Reserved3: 1;
		UINT32	src2_addr_index: 7;
		UINT32	Reserved2: 1;
		UINT32	src2_inpt_sel: 1;
		UINT32	src2_swp_chroma: 2;
		UINT32	Reserved1:1;
		UINT32	src2_linear_gradient:1;
		UINT32	Reserved: 3;
	} Word8;
	struct
	{
		UINT32	sel_s2_alpha_s1s2: 3;
		UINT32	Reserved2: 1;
		UINT32	sel_s1_alpha_s1s2: 3;
		UINT32	Reserved1: 1;
	...
	struct
	{
		UINT32	ROP_code_s1s2: 4;
		UINT32	fb_sel_destclr_blend_s1s2: 4;
		UINT32	fb_sel_srcclr_blend_s1s2: 4;
		UINT32	fb_demultiply_s1s2: 1;
		UINT32	fb_blend_alphachannel_s1s2: 1;
		UINT32	fb_blend_coloralpha_s1s2: 1;
		UINT32	fb_colorize_s1s2: 1;
		UINT32	fb_xor_s1s2: 1;
		UINT32	fb_src_premultiply_s1s2: 1;
		UINT32	fb_src_premulcolor_s1s2: 1;
		UINT32	fb_dst_premultiply_s1s2: 1;
		UINT32	src_clr_transparency_s1s2: 1;//merlin3 no support
		UINT32	src_clr_transform_s1s2: 2;//merlin3 no support
		UINT32	reserved0: 2;
		UINT32	color_key_s1s2: 2;
		UINT32	blend_sel_s1s2: 4;
		UINT32	reserved1: 1;
	} Word10;
	struct
	{
		UINT32	gl_sel_destclr_blend_s1s2: 6;
		UINT32	reserved0: 2;
		UINT32	gl_sel_srcclr_blend_s1s2: 6;
		UINT32	reserved1: 2;
		UINT32	gl_sel_destalpha_s1s2: 6;
		UINT32	reserved2: 2;
		UINT32	gl_sel_src_alpha_s1s2: 6;
		UINT32	reserved3: 2;
	} Word11;
