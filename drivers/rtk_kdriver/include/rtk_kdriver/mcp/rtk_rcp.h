...
#else
#define RTK_RCP_AES_ECB_Encryption(Key, pDataIn, pDataOut, DataLen)       
#define RTK_RCP_AES_ECB_Decryption(Key, pDataIn, pDataOut, DataLen)       
#endif
...
#else
#define RTK_RCP_AES_CBC_Encryption(Key, IV, pDataIn, pDataOut, DataLen)       
#define RTK_RCP_AES_CBC_Decryption(Key, IV, pDataIn, pDataOut, DataLen)       
#endif
...
#else
#define RTK_RCP_AES_CTR_Encryption(Key, IV, pDataIn, pDataOut, DataLen)       
#define RTK_RCP_AES_CTR_Decryption(Key, IV, pDataIn, pDataOut, DataLen)       
#endif
