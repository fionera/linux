...
{
	// Logo Registers
	UINT32 blkhsty_pth[15];
	UINT32 blkhsty_nth[15];
	UINT32 blksamethr_l[15];
	UINT32 blksamethr_a[15];
	UINT32 blksamethr_h[15];
	UINT32 reg_mc_logo_vlpf_en;
	UINT32 reg_km_logo_iir_alpha;
	UINT32 reg_mc_logo_en;

	UINT32 reg_km_logo_blkgrdsum2_th;
	UINT32 reg_km_logo_blkadphstystep_en;
	UINT32 reg_km_logo_blkhsty_nstep;
	UINT32 reg_km_logo_blkhsty_pstep;

	UINT32 dh_logo_bypass[15][5]; // hor/ver/smv/mvd/tmv

	// Others Register
	UINT32 me1_ip_dc_obme_mode_sel;
	UINT32 me1_ip_dc_obme_mode;
	UINT32 me1_ip_ac_obme_mode;
	UINT32 me1_pi_dc_obme_mode_sel;
	UINT32 me1_pi_dc_obme_mode;
	UINT32 me1_pi_ac_obme_mode;
	UINT32 me2_1st_dc_obme_mode_sel;
	UINT32 me2_1st_dc_obme_mode;
	UINT32 me2_1st_ac_obme_mode;
	UINT32 me2_2nd_dc_obme_mode_sel;
	UINT32 me2_2nd_dc_obme_mode;
	UINT32 me2_2nd_ac_obme_mode;

	UINT32 u6_logo_blklogopostdlt_th;
	UINT32 u6_logo_blklogopost_ero_th;
...
typedef struct
{
	...
	UBYTE u1_logo_sc_FastDet_en;
	UBYTE u8_logo_sc_FastDet_rstholdfrm;

	// for SLD
	UINT32 u1_logo_sld_debug_print_en;
	UINT32 u1_logo_sld_debug_print_period;

	UINT32 u8_logo_rglt_pxldf_apl_thr_l;
	UINT32 u8_logo_rglt_pxldf_apl_thr_h;
	UINT32 u8_logo_rglt_pxldf_val_thr_l;
	UINT32 u8_logo_rglt_pxldf_val_thr_h;

	UINT32 u1_logo_rgclr_debug_print;
	UINT32 u1_logo_rgclr_debug_print_period;

	UBYTE u1_logo_rgclr_apl_en;
	UINT32 u32_logo_rgclr_apl_thr;

	UBYTE u1_logo_rgclr_dtl_en;
	UINT32 u32_logo_rgclr_dtl_thr;
	UINT32 u32_logo_rgclr_apl2dtl_thr;

	UBYTE u1_logo_rgclr_cnt_en;
	UINT32 u32_logo_rgclr_cnt_thr;

	UBYTE u1_logo_rgclr_cmp_en;
	UBYTE u8_logo_rgclr_logo_mv_thr;
	UINT32 u32_logo_rgclr_cmp_gain_thr;
	UINT32 u32_logo_rgclr_cmp_ofst_thr;
...
typedef struct
{
	...
	UINT32 u32_logo_closeVar_hold_cnt;

	UBYTE u8_logo_sc_FastDet_cntholdfrm;
	UBYTE u1_logo_sc_FastDet_status;

	UBYTE u1_logo_rgn_distribute[LOGO_RGN_MAX];
	...
	UINT32 u8_PxlRgnDfy[32];
	UINT32 u32_PxlRgClrSig;
