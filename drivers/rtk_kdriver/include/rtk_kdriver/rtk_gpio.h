...
int rtk_gpio_isr_register(RTK_GPIO_ID gid,void (*isr_handler)(RTK_GPIO_ID gid, unsigned char assert, void *dev_id), char *name, unsigned char debounce_time,  unsigned char polarity);
int rtk_gpio_isr_unregister(RTK_GPIO_ID gid,void (*isr_handler) (RTK_GPIO_ID gid, unsigned char assert, void *dev_id));
