...
#define hdcp_otp_debug(fmt, args...)\
		rtd_printk(KERN_DEBUG, "HDCP","[%s][%d] Debug, " fmt, __func__, __LINE__, ## args)
#define hdcp_otp_info(fmt, args...)\
		rtd_printk(KERN_INFO, "HDCP","[%s][%d] Info, " fmt, __func__, __LINE__, ## args)
#else
#define hdcp_otp_debug(fmt, args...)
#define hdcp_otp_info(fmt, args...)
#endif
...
#define hdcp_otp_warning(fmt, args...)\
		rtd_printk(KERN_WARNING, "HDCP","[%s][%d] Warning, " fmt, __func__, __LINE__, ## args)
#define hdcp_otp_err(fmt, args...)\
		rtd_printk(KERN_ERR, "HDCP","[%s][%d] Err, " fmt, __func__, __LINE__, ## args)
