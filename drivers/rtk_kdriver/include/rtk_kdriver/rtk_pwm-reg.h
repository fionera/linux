...
#define  ISO_PWM0_CTRL_VADDR         (ISO_PWM_DB_CTRL_VADDR + 0x4)
#define  ISO_PWM0_TIMING_CTRL_VADDR  (ISO_PWM_DB_CTRL_VADDR + 0x8)
#define  ISO_PWM0_DUTY_SET_VADDR     (ISO_PWM_DB_CTRL_VADDR + 0xC)
#define  ISO_PWM0_ALIGN_VADDR        (ISO_PWM_DB_CTRL_VADDR + 0x10)
#define  ISO_PWM0_TRACKVALUE_VADDR   (ISO_PWM_DB_CTRL_VADDR + 0x14)

#define  ISO_PWM1_CTRL_VADDR         (ISO_PWM_DB_CTRL_VADDR + 0x18)
#define  ISO_PWM1_TIMING_CTRL_VADDR  (ISO_PWM_DB_CTRL_VADDR + 0x1C)
#define  ISO_PWM1_DUTY_SET_VADDR     (ISO_PWM_DB_CTRL_VADDR + 0x20)
#define  ISO_PWM1_ALIGN_VADDR        (ISO_PWM_DB_CTRL_VADDR + 0x24)
#define  ISO_PWM1_TRACKVALUE_VADDR   (ISO_PWM_DB_CTRL_VADDR + 0x28)

#define  ISO_PWM_OD_MODE_VADDR       (ISO_PWM_DB_CTRL_VADDR + 0x2C)
#define  ISO_PWM_NONE                (PWM_RESERVED_VADDR)

//MISC
#define  MIS_PWM_DB0_CTRL_VADDR                     MISC_PWM_PWM_DB0_CTRL_reg
#define  MIS_PWM_DB1_CTRL_VADDR                    (MIS_PWM_DB0_CTRL_VADDR + 0x4)
#define  MIS_PWM0_CTRL_VADDR                       (MIS_PWM_DB0_CTRL_VADDR + 0x8)
#define  MIS_PWM0_TIMING_CTRL_VADDR                (MIS_PWM_DB0_CTRL_VADDR + 0xC)
#define  MIS_PWM0_DUTY_SET_VADDR                   (MIS_PWM_DB0_CTRL_VADDR + 0x10)
#define  MIS_PWM0_DVS_PERIOD_VADDR                 (MIS_PWM_DB0_CTRL_VADDR + 0x14)
#define  MIS_PWM0_DVS_MONITOR_VADDR                (MIS_PWM_DB0_CTRL_VADDR + 0x18)
#define  MIS_PWM0_MONITOR_VADDR                    (MIS_PWM_DB0_CTRL_VADDR + 0x1C)
#define  MIS_PWM0_ERR_STATUS_VADDR                 (MIS_PWM_DB0_CTRL_VADDR + 0x20)
#define  MIS_PWM0_TRACK_SET_VADDR                  (MIS_PWM_DB0_CTRL_VADDR + 0x24)
#define  MIS_PWM0_TRACK_FSM_VADDR                  (MIS_PWM_DB0_CTRL_VADDR + 0x28)
#define  MIS_PWM0_TRACK_PTI_VADDR                  (MIS_PWM_DB0_CTRL_VADDR + 0x2C)
#define  MIS_PWM0_FREQ0_VADDR                      (MIS_PWM_DB0_CTRL_VADDR + 0x30)
#define  MIS_PWM0_FREQ1_VADDR                      (MIS_PWM_DB0_CTRL_VADDR + 0x34)
#define  MIS_PWM0_PHASE0_VADDR                     (MIS_PWM_DB0_CTRL_VADDR + 0x38)
#define  MIS_PWM0_PHASE1_VADDR                     (MIS_PWM_DB0_CTRL_VADDR + 0x3C)
#define  MIS_PWM0_HW_PREDICT_VADDR                 (MIS_PWM_DB0_CTRL_VADDR + 0x40)
#define  MIS_PWM0_SW_PREDICT_VADDR                 (MIS_PWM_DB0_CTRL_VADDR + 0x44)
#define  MIS_PWM0_PREDICT_RATIO_VADDR              (MIS_PWM_DB0_CTRL_VADDR + 0x48)

#define  MIS_PWM1_CTRL_VADDR                       (MIS_PWM_DB0_CTRL_VADDR + 0x4C)
#define  MIS_PWM1_TIMING_CTRL_VADDR                (MIS_PWM_DB0_CTRL_VADDR + 0x50)
#define  MIS_PWM1_DUTY_SET_VADDR                   (MIS_PWM_DB0_CTRL_VADDR + 0x54)
#define  MIS_PWM1_DVS_PERIOD_VADDR                 (MIS_PWM_DB0_CTRL_VADDR + 0x58)
#define  MIS_PWM1_DVS_MONITOR_VADDR                (MIS_PWM_DB0_CTRL_VADDR + 0x5C)
#define  MIS_PWM1_MONITOR_VADDR                    (MIS_PWM_DB0_CTRL_VADDR + 0x60)
#define  MIS_PWM1_ERR_STATUS_VADDR                 (MIS_PWM_DB0_CTRL_VADDR + 0x64)
#define  MIS_PWM1_TRACK_SET_VADDR                  (MIS_PWM_DB0_CTRL_VADDR + 0x68)
#define  MIS_PWM1_TRACK_FSM_VADDR                  (MIS_PWM_DB0_CTRL_VADDR + 0x6C)
#define  MIS_PWM1_TRACK_PTI_VADDR                  (MIS_PWM_DB0_CTRL_VADDR + 0x70)
#define  MIS_PWM1_FREQ0_VADDR                      (MIS_PWM_DB0_CTRL_VADDR + 0x74)
#define  MIS_PWM1_FREQ1_VADDR                      (MIS_PWM_DB0_CTRL_VADDR + 0x78)
#define  MIS_PWM1_PHASE0_VADDR                     (MIS_PWM_DB0_CTRL_VADDR + 0x7C)
#define  MIS_PWM1_PHASE1_VADDR                     (MIS_PWM_DB0_CTRL_VADDR + 0x80)
#define  MIS_PWM1_HW_PREDICT_VADDR                 (MIS_PWM_DB0_CTRL_VADDR + 0x84)
#define  MIS_PWM1_SW_PREDICT_VADDR                 (MIS_PWM_DB0_CTRL_VADDR + 0x88)
#define  MIS_PWM1_PREDICT_RATIO_VADDR              (MIS_PWM_DB0_CTRL_VADDR + 0x8C)

#define  MIS_PWM2_CTRL_VADDR                       (MIS_PWM_DB0_CTRL_VADDR + 0x90)
#define  MIS_PWM2_TIMING_CTRL_VADDR                (MIS_PWM_DB0_CTRL_VADDR + 0x94)
#define  MIS_PWM2_DUTY_SET_VADDR                   (MIS_PWM_DB0_CTRL_VADDR + 0x98)
...
#define  MIS_PWM3_CTRL_VADDR                       (MIS_PWM_DB0_CTRL_VADDR + 0x9C)
#define  MIS_PWM3_TIMING_CTRL_VADDR                (MIS_PWM_DB0_CTRL_VADDR + 0xA0)
#define  MIS_PWM3_DUTY_SET_VADDR                   (MIS_PWM_DB0_CTRL_VADDR + 0xA4)
...
#define  MIS_PWM4_CTRL_VADDR                       (MIS_PWM_DB0_CTRL_VADDR + 0xA8)
#define  MIS_PWM4_TIMING_CTRL_VADDR                (MIS_PWM_DB0_CTRL_VADDR + 0xAC)
#define  MIS_PWM4_DUTY_SET_VADDR                   (MIS_PWM_DB0_CTRL_VADDR + 0xB0)
...
#define  MIS_PWM5_CTRL_VADDR                       (MIS_PWM_DB0_CTRL_VADDR + 0xB4)
#define  MIS_PWM5_TIMING_CTRL_VADDR                (MIS_PWM_DB0_CTRL_VADDR + 0xB8)
#define  MIS_PWM5_DUTY_SET_VADDR                   (MIS_PWM_DB0_CTRL_VADDR + 0xBC)
...
#define  MIS_PWM6_CTRL_VADDR                       (MIS_PWM_DB0_CTRL_VADDR + 0xC0)
#define  MIS_PWM6_TIMING_CTRL_VADDR                (MIS_PWM_DB0_CTRL_VADDR + 0xC4)
#define  MIS_PWM6_DUTY_SET_VADDR                   (MIS_PWM_DB0_CTRL_VADDR + 0xC8)
...
#define  MIS_PWM7_CTRL_VADDR                       (MIS_PWM_DB0_CTRL_VADDR + 0xCC)
#define  MIS_PWM7_TIMING_CTRL_VADDR                (MIS_PWM_DB0_CTRL_VADDR + 0xD0)
#define  MIS_PWM7_DUTY_SET_VADDR                   (MIS_PWM_DB0_CTRL_VADDR + 0xD4)
...
#define  MIS_PWM_HW_PREDICT_FROM_D_DOMAIN_VADDR    (MIS_PWM_DB0_CTRL_VADDR + 0xD8)
#define  MIS_PWM_OD_MODE_VADDR                     (MIS_PWM_DB0_CTRL_VADDR + 0xDC)
#define  MIS_DUMMY_VADDR                           (MIS_PWM_DB0_CTRL_VADDR + 0xE0)
