...
#define RTKVDEC_COMEM_DCU1_ALLOC 0x7
#define RTKVDEC_COMEM_DCU2_ALLOC 0x8

#define RTKVDEC_PROC_DIR		"rtkvdec"
#define RTKVDEC_PROC_ENTRY      	"statistics"
#define RTKVDEC_MAX_CMD_LENGTH 256

#define RTKVDEC_MAX_SVPMEM_NUM 5
...
#define RTKVDEC_SVPMEM_SIZE_20M 0x1400000

#define RTKVDEC_MAX_VBM_MEM_NUM 8
...
typedef struct VDEC_ECP_STRUCT {
	unsigned int saddr ;
	unsigned int eaddr ;
	VDEC_ECP_TYPE type ;
	unsigned int mode ;
...
typedef struct VDEC_RBINFO_STRUCT {
	unsigned char nPort ;
	unsigned int bsRingHeader ;
...
#endif
#define VDEC_IOC_ECP_PROTECTION  _IOW (VDEC_IOC_MAGIC,22, int)
