...
TP_EXTERN INT32 RHAL_Delivery_SetMode(UINT8 mode);
...
TP_EXTERN INT32 RHAL_TP_EnableProtect(TPK_TP_ENGINE_T tp_id);
TP_EXTERN INT32 RHAL_TP_DisableProtect(TPK_TP_ENGINE_T tp_id);
TP_EXTERN INT32 RHAL_TP_CheckProtectStatus(TPK_TP_ENGINE_T tp_id, UINT8 *isNeedEnterProtect);
