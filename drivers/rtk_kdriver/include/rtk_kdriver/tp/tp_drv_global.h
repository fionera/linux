...
#define TP_PROC_PARAM_RECORD_TLV1_EN        "record_tlv1_en="           /*  start & stop record tlv from TP ring buffer (0: stop record; 1: start record) */
#define TP_PROC_PARAM_RECORD_TLV2_EN        "record_tlv2_en="           /*  start & stop record tlv from TP ring buffer (0: stop record; 1: start record) */
...
typedef enum {
        ...
        TP_PROC_RECORD_TLV1_EN,          /* start & stop record TLV from TP ring buffer (0: stop record; 1: start record) */
        TP_PROC_RECORD_TLV2_EN,          /* start & stop record TLV from TP ring buffer (0: stop record; 1: start record) */
