...
{
	HAL_VPQ_ENG_HDR10p_EN = 0,
	HAL_VPQ_ENG_HDR10p_EOTF_Gain,
	HAL_VPQ_ENG_HDR10p_EOTF_Linear_W,
 ...
 * Structure
 ******************************************************************************/
#define HAL_VPQ_ENG_ID_MAX_NUM (HAL_VPQ_Coef_ID_MAX_NUM+HAL_VPQ_Extend_Coef_ID_MAX_NUM+HAL_VPQ_OTHER_ID_MAX_NUM+HAL_VPQ_HDR_ID_MAX_NUM)
