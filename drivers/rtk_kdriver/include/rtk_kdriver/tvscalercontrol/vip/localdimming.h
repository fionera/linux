...
typedef struct
{
	...
	unsigned char hal_ld_spatialnewcoef20;
	unsigned char hal_ld_spatialnewcoef21;
	unsigned char hal_ld_spatialnewcoef22;
	unsigned char hal_ld_spatialnewcoef23;
	unsigned char hal_ld_spatialnewcoef24;
	unsigned char hal_ld_spatialnewcoef25;	
	unsigned char hal_ld_spatialnewcoef30;
	unsigned char hal_ld_spatialnewcoef31;
	unsigned char hal_ld_spatialnewcoef32;
	unsigned char hal_ld_spatialnewcoef33;
	unsigned char hal_ld_spatialnewcoef34;
	unsigned char hal_ld_spatialnewcoef35;
	unsigned char hal_ld_spatialnewcoef40;
	unsigned char hal_ld_spatialnewcoef41;
	unsigned char hal_ld_spatialnewcoef50;
...
typedef struct {
	unsigned char hal_ld_blk_hnum;
	unsigned char hal_ld_blk_vnum;
	unsigned short hal_ld_blk_hsize;
	unsigned short hal_ld_blk_vsize;
} KADP_LED_GLOBAL_CTRL;
...
typedef struct
{
	...
	KADP_LED_GLOBAL_CTRL hal_global_ctrl;
} KADP_LED_DB_LUT_T;
