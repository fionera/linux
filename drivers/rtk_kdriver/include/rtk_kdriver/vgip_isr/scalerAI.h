...
******************************************************************************/
// total (3+3+280)*3 + 20
#define CONFIG_RTK_KDRV_AI 1
#define VIP_NN_BUFFER_NUM 3
...
void AI_dynamic_ICM_offset(int faceIdx, AIInfo face, int *h_adj_o, int *s_adj_o, int *v_adj_o); // lesley 0808
void AI_ICM_tuning(int faceIdx, AIInfo face);
// chen 0426
void ICM_adjust_valuen(int hue_info, int sat_info, int val_info, int *hue_delta, int *sat_delta, int *val_delta, COLORELEM ICM_TAB_ACCESS[8][12][60]);
