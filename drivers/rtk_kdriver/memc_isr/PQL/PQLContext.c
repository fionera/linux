...
#include "common/include/rbus/ppoverlay_reg.h"
...
VOID Debug_Msg_Print(_PQLPARAMETER* g_pParam, _PQLCONTEXT* pContext)
{
	...
	UINT32 u32_oFrameRateTh = (27000000/110 - 27000000/120)/2;
	UINT32 u32_iFrameRate = 0;
	UINT32 u32_oFrameRate = 0;
	static UINT32 u32_iFrameRate_Pre = 0;
	static UINT32 u32_oFrameRate_Pre = 0;
	UBYTE u1_trig_inPhase_noMatch, u1_trig_outPhase_noMatch, u1_trig_iFrameRate_noMatch, u1_trig_oFrameRate_noMatch, u1_IOPhase_N2M_logEn, u1_IOPhase_N2M_FrameRate_logEn;
	UINT32 ippre_mute_hde_min_abn = 0, ippre_mute_hde_max_abn = 0, ippre_mute_htotal_abn = 0, ippre_mute_vde_min_abn = 0, ippre_mute_vde_max_abn = 0, ippre_mute_vact = 0, ippre_mute_hact = 0;
	UINT32 mc_wrt_idx = 0, mc_read_i_idx = 0, mc_read_p_idx = 0, bBGEn = 0, MEMC_BGEn = 0, MEMC_MuxEn = 0;
	...
	ReadRegister(FRC_TOP__KPOST_TOP__bluescreen_ADDR, 30, 30, &MEMC_BGEn);
	...
	if(u1_trig_inPhase_noMatch && u1_IOPhase_N2M_logEn)
		rtd_printk(KERN_NOTICE, TAG_NAME_MEMC, "[FR] inPhase >= N!!!(inPh = %d, N = %d)\n\r", in_phase, s_pContext->_output_frc_phtable.u8_sys_N_pre);
	if(u1_trig_outPhase_noMatch && u1_IOPhase_N2M_logEn)
		rtd_printk(KERN_NOTICE, TAG_NAME_MEMC, "[FR] outPhase > M!!!(outPh = %d, M = %d)\n\r", out_phase, s_pContext->_output_frc_phtable.u8_sys_M_pre);
	if(u1_trig_iFrameRate_noMatch  && u1_IOPhase_N2M_FrameRate_logEn)
		rtd_printk(KERN_NOTICE, TAG_NAME_MEMC, "[FR] in FrameRate Change!!!(%dHz(%d) -> %dHz(%d))(90K = %d)\n\r", u32_iFrameRateHz_pre, u32_iFrameRate_Pre, u32_iFrameRateHz, u32_iFrameRate, rtd_inl(0xB801B6B8));
	if(u1_trig_oFrameRate_noMatch  && u1_IOPhase_N2M_FrameRate_logEn)
		rtd_printk(KERN_NOTICE, TAG_NAME_MEMC, "[FR] out FrameRate Change!!!(%dHz(%d) -> %dHz(%d))(90K = %d)\n\r", u32_oFrameRateHz_pre, u32_oFrameRate_Pre, u32_oFrameRateHz, u32_oFrameRate, rtd_inl(0xB801B6B8));

	//input size monitor
	ReadRegister(KIWI_REG(FRC_TOP__IPPRE__regr_ippre_mute_hde_min_abn), &ippre_mute_hde_min_abn);
	ReadRegister(KIWI_REG(FRC_TOP__IPPRE__regr_ippre_mute_hde_max_abn), &ippre_mute_hde_max_abn);
	ReadRegister(KIWI_REG(FRC_TOP__IPPRE__regr_ippre_mute_htotal_abn), &ippre_mute_htotal_abn);
	ReadRegister(KIWI_REG(FRC_TOP__IPPRE__regr_ippre_mute_vde_min_abn), &ippre_mute_vde_min_abn);
	ReadRegister(KIWI_REG(FRC_TOP__IPPRE__regr_ippre_mute_vde_max_abn), &ippre_mute_vde_max_abn);
	ReadRegister(KIWI_REG(FRC_TOP__IPPRE__regr_ippre_mute_vact), &ippre_mute_vact);
	ReadRegister(KIWI_REG(FRC_TOP__IPPRE__regr_ippre_mute_hact), &ippre_mute_hact);
	if(display_timing_ctrl1_reg.disp_en == 1 && ((Scaler_DispGetInputInfoByDisp(SLR_MAIN_DISPLAY, SLR_INPUT_STATE) == _MODE_STATE_ACTIVE) || MEMC_error_status_print_flag)){
		if(ippre_mute_hde_min_abn && MEMC_MuxEn){
			rtd_printk(KERN_NOTICE, TAG_NAME_MEMC, "[inpur size error] hde_min_abn(b80991f4[13]) !!!(BG=%d/%d)(MEMC_Mux=%d)(90K = %d)\n\r", bBGEn, MEMC_BGEn, MEMC_MuxEn, rtd_inl(0xB801B6B8));
			WriteRegister(KIWI_REG(FRC_TOP__IPPRE__regr_ippre_mute_hde_min_abn), 0x1);
		}
		if(ippre_mute_hde_max_abn && MEMC_MuxEn){
			rtd_printk(KERN_NOTICE, TAG_NAME_MEMC, "[inpur size error] hde_max_abn(b80991f4[14]) !!!(BG=%d/%d)(MEMC_Mux=%d)(90K = %d)\n\r", bBGEn, MEMC_BGEn, MEMC_MuxEn, rtd_inl(0xB801B6B8));
			WriteRegister(KIWI_REG(FRC_TOP__IPPRE__regr_ippre_mute_hde_max_abn), 0x1);
		}
		if(ippre_mute_htotal_abn && MEMC_MuxEn){
			rtd_printk(KERN_NOTICE, TAG_NAME_MEMC, "[inpur size error] htotal_abn(b80991f4[15]) !!!(BG=%d/%d)(MEMC_Mux=%d)(90K = %d)\n\r", bBGEn, MEMC_BGEn, MEMC_MuxEn, rtd_inl(0xB801B6B8));
			WriteRegister(KIWI_REG(FRC_TOP__IPPRE__regr_ippre_mute_htotal_abn), 0x1);
		}
		if(ippre_mute_vde_min_abn && MEMC_MuxEn){
			rtd_printk(KERN_NOTICE, TAG_NAME_MEMC, "[inpur size error] vde_min_abn(b80991f4[16]) !!!(BG=%d/%d)(MEMC_Mux=%d)(90K = %d)\n\r", bBGEn, MEMC_BGEn, MEMC_MuxEn, rtd_inl(0xB801B6B8));
			WriteRegister(KIWI_REG(FRC_TOP__IPPRE__regr_ippre_mute_vde_min_abn), 0x1);
		}
		if(ippre_mute_vde_max_abn && MEMC_MuxEn){
			rtd_printk(KERN_NOTICE, TAG_NAME_MEMC, "[inpur size error] vde_max_abn(b80991f4[17]) !!!(BG=%d/%d)(MEMC_Mux=%d)(90K = %d)\n\r", bBGEn, MEMC_BGEn, MEMC_MuxEn, rtd_inl(0xB801B6B8));
			WriteRegister(KIWI_REG(FRC_TOP__IPPRE__regr_ippre_mute_vde_max_abn), 0x1);
		}
		if(ippre_mute_hact != 1920 && MEMC_MuxEn){
			rtd_printk(KERN_NOTICE, TAG_NAME_MEMC, "[inpur size error] hact (b80991f0[8:19] = %d) !!!(BG=%d/%d)(MEMC_Mux=%d)(90K = %d)\n\r", ippre_mute_hact, bBGEn, MEMC_BGEn, MEMC_MuxEn, rtd_inl(0xB801B6B8));
		}
		if(ippre_mute_vact != 2160 && MEMC_MuxEn){
			rtd_printk(KERN_NOTICE, TAG_NAME_MEMC, "[inpur size error] vact (b80991f0[20:31] = %d) !!!(BG=%d/%d)(MEMC_Mux=%d)(90K = %d)\n\r", ippre_mute_vact, bBGEn, MEMC_BGEn, MEMC_MuxEn, rtd_inl(0xB801B6B8));
		}
	}

	mc_wrt_idx = (rtd_inl(0xb809d490)>>0)&0xf;
	mc_read_i_idx = (rtd_inl(0xb809d490)>>4)&0xf;
	mc_read_p_idx = (rtd_inl(0xb809d490)>>8)&0xf;
	if(mc_wrt_idx == mc_read_i_idx ||mc_wrt_idx == mc_read_p_idx){
		//rtd_printk(KERN_NOTICE, TAG_NAME_MEMC, "[MC idx error] wrt=%d, read_i=%d, read_p=%d (90K = %d)\n\r", (rtd_inl(0xb809d490)>>0)&0xf, (rtd_inl(0xb809d490)>>4)&0xf, (rtd_inl(0xb809d490)>>8)&0xf, rtd_inl(0xB801B6B8));
	}
...
VOID PQL_ContextProc_oneFifth_outputInterrupt(SINT32 iSliceIdx)
{
	...
	ReadRegister(KIWI_REG(FRC_TOP__PQL_0__pql_onefifth_intp_en), &u32_rb_data);
	...
	if(u32_rb_data)
	{
		...
		Wrt_ComReg_Proc_oneFifth_outInterrupt(&(s_pParam->_param_wrt_comreg), &(s_Context._output_wrt_comreg)); //K6_BRING_UP//
...
{
	UINT32 u32_rb_data = 0xFFFFFFFF;
	ReadRegister(KIWI_REG(FRC_TOP__PQL_0__pql_input_intp_en), &u32_rb_data);
...
{
	UINT32 u32_rb_data = 0xFFFFFFFF;
	ReadRegister(KIWI_REG(FRC_TOP__PQL_0__pql_output_intp_en), &u32_rb_data);
...
BOOL PQL_GetMEMCActSafeStatus(VOID)
{
	...
	ReadRegister(KIWI_REG(FRC_TOP__MC__mc_bld_bypass), &blending_mode);
...
// MEMC_K6L_BRING_UP //	UINT32 kmc_00_wram_err, kmc_01_wram_err;

	static UINT32 FrameCnt = 0;
	static UINT32 FirstFrame = 1;//first readback data is wrong, ignore it

	u32_En = 1;
	ReadRegister(KIWI_REG(FRC_TOP__KMC_TOP__kmc_in_measure_en), &u32_En_pre);

	//if(u32_En_pre != u32_En) //fix me
	{
		WriteRegister(FRC_TOP__KMC_TOP__kmc_in_measure_en_ADDR, 6, 6, u32_En);
		WriteRegister(FRC_TOP__KPOST_TOP__post_out_measure_en_ADDR, 19, 19, u32_En);

		WriteRegister(FRC_TOP__KMC_TOP__kmc_in_measure_en_ADDR, 3, 5, 0x7);
		WriteRegister(FRC_TOP__KPOST_TOP__post_out_measure_en_ADDR, 16, 18, 0x7);

		WriteRegister(FRC_TOP__KMC_TOP__kmc_in_measure_en_ADDR, 7, 18, 0x121);
		WriteRegister(FRC_TOP__KPOST_TOP__post_out_measure_en_ADDR, 20, 31, 0x121);
	}
...
// MEMC_K6L_BRING_UP //		ReadRegister(KIWI_REG(FRC_TOP__KMC_DM_TOP__regr_kmc_00_wram_rw_err), &kmc_00_wram_err);
// MEMC_K6L_BRING_UP //		ReadRegister(KIWI_REG(FRC_TOP__KMC_DM_TOP__regr_kmc_01_wram_rw_err), &kmc_01_wram_err);
	...
	//[MEMC_overflow]-------------
		...
		ReadRegister(FRC_TOP__KME_ME1_TOP0__me1_ip_dummy0_ADDR,29,29,&me1_ip_dummy0_29);
...
VOID RTICEDebug_OnlineMeasure(UBYTE int_type)
{
	...
	*/
	...
	ReadRegister(FRC_TOP__KME_ME1_TOP0__me1_ip_dummy0_ADDR, 0, 31, &u32_reg_value);

	u8_dump_mode = u32_reg_value>>31;
	if (u16_dump_timer == 0)
	{
		u16_dump_timer = ((u32_reg_value>>24) & 0x7f) * 32;
		WriteRegister(FRC_TOP__KME_ME1_TOP0__me1_ip_dummy0_ADDR, 24, 30, 0);
...
// MEMC_K6L_BRING_UP //				ReadRegister(KIWI_REG(FRC_TOP__KME_DM_TOP2__regr_mv12_overflow_error), &tmp5);
...
// MEMC_K6L_BRING_UP //				ReadRegister(KIWI_REG(FRC_TOP__KMC_DM_TOP__regr_kmc_00_headerfail), &tmp);
// MEMC_K6L_BRING_UP //				ReadRegister(KIWI_REG(FRC_TOP__KMC_DM_TOP__regr_kmc_01_headerfail), &tmp2);
// MEMC_K6L_BRING_UP //				ReadRegister(KIWI_REG(FRC_TOP__KMC_DM_TOP__regr_kmc_02_headerfail), &tmp3);
// MEMC_K6L_BRING_UP //				ReadRegister(KIWI_REG(FRC_TOP__KMC_DM_TOP__regr_kmc_03_headerfail), &tmp4);
// MEMC_K6L_BRING_UP //				ReadRegister(KIWI_REG(FRC_TOP__KMC_DM_TOP__regr_kmc_04_headerfail), &tmp5);
// MEMC_K6L_BRING_UP //				ReadRegister(KIWI_REG(FRC_TOP__KMC_DM_TOP__regr_kmc_05_headerfail), &tmp6);
// MEMC_K6L_BRING_UP //				ReadRegister(KIWI_REG(FRC_TOP__KMC_DM_TOP__regr_kmc_06_headerfail), &tmp7);
// MEMC_K6L_BRING_UP //				ReadRegister(KIWI_REG(FRC_TOP__KMC_DM_TOP__regr_kmc_07_headerfail), &tmp8);
...
// MEMC_K6L_BRING_UP //				ReadRegister(KIWI_REG(FRC_TOP__KMC_DM_TOP__regr_kmc_00_fail), &tmp);
// MEMC_K6L_BRING_UP //				ReadRegister(KIWI_REG(FRC_TOP__KMC_DM_TOP__regr_kmc_01_fail), &tmp2);
// MEMC_K6L_BRING_UP //				ReadRegister(KIWI_REG(FRC_TOP__KMC_DM_TOP__regr_kmc_02_fail), &tmp3);
// MEMC_K6L_BRING_UP //				ReadRegister(KIWI_REG(FRC_TOP__KMC_DM_TOP__regr_kmc_03_fail), &tmp4);
// MEMC_K6L_BRING_UP //				ReadRegister(KIWI_REG(FRC_TOP__KMC_DM_TOP__regr_kmc_04_fail), &tmp5);
// MEMC_K6L_BRING_UP //				ReadRegister(KIWI_REG(FRC_TOP__KMC_DM_TOP__regr_kmc_05_fail), &tmp6);
// MEMC_K6L_BRING_UP //				ReadRegister(KIWI_REG(FRC_TOP__KMC_DM_TOP__regr_kmc_06_fail), &tmp7);
// MEMC_K6L_BRING_UP //				ReadRegister(KIWI_REG(FRC_TOP__KMC_DM_TOP__regr_kmc_07_fail), &tmp8);
