...
_PQLPARAMETER PQL_Glb_Param  =
{
	...
	/*Dh-close:_param_dh_close*/
	{
		...
		0,				  //UBYTE  u2_dh_me1_ip_dc_obme_mode_off;
		0,				  //UBYTE  u2_dh_me1_pi_dc_obme_mode_off;
		0,				  //UBYTE  u2_dh_me1_ip_ac_obme_mode_off;
		0,				  //UBYTE  u2_dh_me1_pi_ac_obme_mode_off;

		0,				  //UBYTE  u2_dh_me1_ip_dc_obme_mode_on;
		0,				  //UBYTE  u2_dh_me1_pi_dc_obme_mode_on;
		0,				  //UBYTE  u2_dh_me1_ip_ac_obme_mode_on;
		0,				  //UBYTE  u2_dh_me1_pi_ac_obme_mode_on;

		0,             	  // UBYTE  u1_dbg_print_en;
	},
	...
	/*sceneAnalysis:_param_frc_sceneAnalysis*/
	{
		...
		0,		//UBYTE u1_me1_gmvd_Sel_en;
		0,		//UBYTE u11_me1_gmvd_Sel_mvx_diff_thr;
		0,		//UBYTE u10_me1_gmvd_Sel_mvy_diff_thr;
		0,		//UBYTE u4_me1_gmvd_Sel_1st_gmv_ratio_thr;
		0,		//UBYTE u4_me1_gmvd_Sel_2nd_gmv_ratio_thr;

		0,		//	UBYTE  u1_SA_en;
		0,		//	UINT32 u20_SA_good_rgn_SAD_th;
		0,		//	UINT32 u12_SA_good_rgn_unconf_th;
		0,		//	UINT32 u12_SA_good_rgn_TC_th;
		0,		//	UBYTE  u5_SA_good_rgn_num_th;
		0,		//	UBYTE  u5_SA_bad_rgn_num_th;
		0,		//	UBYTE  u4_SA_good_scene_enter_cnt;
		0,		//	UBYTE  u4_SA_bad_scene_enter_cnt;
		0,		//	UINT32 u20_SA_bad_rgn_SAD_th;
		0,		//	UINT32 u12_SA_bad_rgn_unconf_th;
		0,		//	UINT32 u12_SA_bad_rgn_TC_th;
		0,		//	UBYTE  u3_SA_bad_scene_keep_cnt;
		0,		//  UBYTE  u8_SC_PFV_CDD_hold_cnt
		0,  //u1_mv_accord_en;
	...
	/*Write-Register:_param_wrt_comreg*/
	{
		...
		1,		//UBYTE   u1_localfb_wrt_en;
		1,              //UBYTE  u1_scCtrl_wrt_en;
		1,              //UBYTE  u1_MECand_wrt_en;
		1,              //UBYTE  u1_MECandPnt_wrt_en;
		1,              //UBYTE  u1_GMV_wrt_en;
		1,              //UBYTE  u1_ME_ipme_flp_alp_wrt_en;
		1,              //UBYTE  u1_ME_mvd_cuv_wrt_en;
		1,              //UBYTE  u1_ME_AdptPnt_rnd_wrt_en;
