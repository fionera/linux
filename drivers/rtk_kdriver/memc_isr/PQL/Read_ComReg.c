...
VOID ReadComReg_Proc_inputInterrupt(const _PARAM_ReadComReg *pParam, _OUTPUT_ReadComReg *pOutput)
{
	...
	if(pParam->u1_lg_blk_cnt_rb_en == 1)
	{
		...
		{
			ReadRegister(FRC_TOP__KME_LOGO2__regr_km_logo_pxlrg_idx0_cnt_ADDR + idx * 4,
						 FRC_TOP__KME_LOGO2__regr_km_logo_pxlrg_idx0_cnt_BITSTART,
						 FRC_TOP__KME_LOGO2__regr_km_logo_pxlrg_idx0_cnt_BITEND, &u32_RB_val);
			pOutput->u14_pxllogo_rgcnt[idx*2+0] = u32_RB_val;

			ReadRegister(FRC_TOP__KME_LOGO2__regr_km_logo_pxlrg_idx1_cnt_ADDR + idx * 4,
						 FRC_TOP__KME_LOGO2__regr_km_logo_pxlrg_idx1_cnt_BITSTART,
						 FRC_TOP__KME_LOGO2__regr_km_logo_pxlrg_idx1_cnt_BITEND, &u32_RB_val);
		...
		{
			ReadRegister(FRC_TOP__KMC_METER_TOP__regr_kmc_meter_rdbk_histo00_ADDR + idx * 4,
						 FRC_TOP__KMC_METER_TOP__regr_kmc_meter_rdbk_histo00_BITSTART,
						 FRC_TOP__KMC_METER_TOP__regr_kmc_meter_rdbk_histo00_BITEND, &u32_RB_val);
