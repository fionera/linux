...
void rtk_local_dimming_enable(void)
{
   ...
   rtd_part_outl(LDSPI_V_sync_duty_reg,31,24,0xaf); //Vsync_d		   T5=(Vsync_d+1)*128*4 = 30.2us
	...
	//rtd_printk(KERN_WARNING, "PWM_LD" ,"[pyToolOpt]BKlight:%d,local_dim_block%d,localDimming:%d\n",webos_tooloption.eBackLight, webos_tooloption.eLEDBarType,webos_tooloption.bLocalDimming);
	rtd_printk(KERN_WARNING, "PWM_LD" ,"[pyToolOpt]BKlight:%s,local_dim_block%s,localDimming:%d\n",webos_strToolOption.eBackLight, webos_strToolOption.eLEDBarType,webos_strToolOption.bLocalDimming);
      //if ((webos_tooloption.eBackLight == 0) && (webos_tooloption.eLEDBarType == 2) && (webos_tooloption.bLocalDimming == 1)) {
	if ((strcmp(webos_strToolOption.eBackLight, "direct") == 0) && (strcmp(webos_strToolOption.eLEDBarType,"32")==0) && (webos_strToolOption.bLocalDimming == 1)) {
			...
			rtd_part_outl(LDSPI_Data_Rwport_reg,11,0,0xAA); //data : ID^M
       ...
       //} else if ((webos_tooloption.eBackLight == 0) && (webos_tooloption.eLEDBarType == 6) && (webos_tooloption.bLocalDimming == 1)) {
       	    } else if ((strcmp(webos_strToolOption.eBackLight, "direct") == 0) && (strcmp(webos_strToolOption.eLEDBarType,"50")==0) && (webos_strToolOption.bLocalDimming == 1)) {


			rtd_part_outl(LDSPI_Out_data_CTRL_reg,16,4,0x36); //Output Unit:8 unit(= set+1)
			...
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x1E);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x1F);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x20);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x21);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x22);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x23);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x24);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x25);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x26);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x27);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x28);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x29);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x2A);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x2B);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x2C);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x2D);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x2E);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x2F);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x30);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x31);
			////backlight control^M
			rtd_part_outl(LDSPI_Data_Addr_CTRL_reg,27,16,0x0); //Data index
			rtd_part_outl(LDSPI_Data_Rwport_reg,11,0,0xff);
			rtd_part_outl(LDSPI_Data_Rwport_reg,11,0,0xff);
	   ...
	   //} else if ((webos_tooloption.eBackLight == 0) && (webos_tooloption.eLEDBarType == 7) && (webos_tooloption.bLocalDimming == 1)) {
	    } else if ((strcmp(webos_strToolOption.eBackLight, "direct") == 0) && (strcmp(webos_strToolOption.eLEDBarType,"90")==0) && (webos_strToolOption.bLocalDimming == 1)) {
			rtd_part_outl(LDSPI_Out_data_CTRL_reg,16,4,0x5E); //Output Unit:8 unit(= set+1)
			...
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x30);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x31);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x32);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x33);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x34);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x35);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x36);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x37);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x38);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x39);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x3A);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x3B);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x3C);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x3D);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x3E);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x3F);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x40);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x41);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x42);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x43);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x44);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x45);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x46);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x47);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x48);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x49);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x4A);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x4B);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x4C);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x4D);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x4E);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x4F);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x50);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x51);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x52);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x53);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x54);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x55);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x56);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x57);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x58);
			rtd_part_outl(LDSPI_Outindex_Rwport_reg,11,0,0x59);
	...
	if(Get_DISPLAY_REFRESH_RATE() == 60){
		...
		rtd_part_outl(LDSPI_ld_spi_h_total_reg,31,19, Get_DISP_HORIZONTAL_TOTAL()/2);  //ld_spi_dh_total ,reproduce hsync signal	 0x112f 4k
