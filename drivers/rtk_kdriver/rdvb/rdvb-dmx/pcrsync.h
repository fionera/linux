...
typedef struct PCRSYNC_T_ {
    ...
    bool bForceHackPCR;
    bool bUseAudioPTS;
    bool bUseFixedRCD;      /*for tv006 SDEC_StopPCRRecovery issue*/
...
//bool PCRSYNC_GetAVSyncStatus(PCRSYNC_T *pPcrProcesser);
//void PCRSYNC_SetAudioType(PCRSYNC_T *pPcrProcesser, AUDIO_DEC_TYPE audioType);

bool PCRSYNC_GetRCDUnstableStatus(const PCRSYNC_T *pPcrProcesser,
                int64_t *rcdUnstableCount, int64_t *rcdUnstableCheckCount);
void PCRSYNC_SetFreeRunMode(PCRSYNC_T *processor, bool isUnderFreeRunMode);
bool PCRSYNC_IsUnderFreeRunMode(const PCRSYNC_T *pcrocessor);
bool PCRSYNC_EvaluateRcdStability(PCRSYNC_T *processor, int64_t newPcr, int64_t newStc);
void PCRSYNC_EnterFreeRunMode(PCRSYNC_T *pcrocessor);
void PCRSYNC_ReturnToPCRMaster(PCRSYNC_T *pcrocessor);
...
bool PCRSYNC_ShouldResetRcdStabilityCheckStatus(const PCRSYNC_T *processor);
