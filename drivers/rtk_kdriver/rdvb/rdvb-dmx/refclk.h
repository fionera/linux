#ifndef __REFERENCE_CLOCK_H
#define __REFERENCE_CLOCK_H

#include "rpc_common.h"
#include "rdvb-common/clock.h"

#define DEFAULT_FREE_RUN_THRESHOLD (5*90000) // 5 seconds
...
//https://harmony.lge.com:8443/issue/browse/KTASKWBS-3085
//https://harmony.lge.com:8443/issue/browse/WOSQRTK-4967
//https://harmony.lge.com:8443/issue/browse/WOSQRTK-8482
#define FREE_RUN_THRESHOLD_FOR_MTP (3*90000)

/*https://harmony.lge.com:8443/issue/browse/KTASKWBS-5144*/
...
void REFCLK_SetClockMode(REFCLOCK *pRefClock, enum clock_type clock);
