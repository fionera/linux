...
VPQC_FILE_struct file_info[1000]={0};
...
//	VPQ_GenFile_setfile_info(&file_info[File_item], VPQUT_IOC_PQ_CMD_SET_SU_table_6tap, &SU_table_6tap, sizeof(SU_table_6tap));	File_item++;
	...
	//VPQ_GenFile_setfile_info(&file_info[File_item], VPQUT_IOC_PQ_CMD_SET_gBSTable, &gBSTable, sizeof(gBSTable));	File_item++;//k5l hw remove
