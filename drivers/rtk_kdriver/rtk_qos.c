...
static int rtk_qos_load_mc_decoder_4k_jp_setting(void)
{
	pr_debug("[QOS] DECODER 4K JP\n");
	...
	rtd_outl(0xb8008a24,0x00180630);
	rtd_outl(0xb8008a28,0x0000210e);
	rtd_outl(0xb8008a2c,0x001f0007);
	rtd_outl(0xb8008a30,0x000f0007);
	rtd_outl(0xb8008a34,0x03ff0000);
	rtd_outl(0xb8008a3c,0x00ffffff);

	rtd_outl(0xb8008a40,0x0984080c);
	rtd_outl(0xb8008a44,0x6e006e00);
	rtd_outl(0xb8008a48,0x04002008);
	rtd_outl(0xb8008a4c,0x40020061);

	rtd_outl(0xb8008a50,0x0984089c);
	rtd_outl(0xb8008a54,0x46004600);
	rtd_outl(0xb8008a58,0x7ff20008);
	rtd_outl(0xb8008a5c,0x00020081);

	rtd_outl(0xb8008a60,0x09840806);
	rtd_outl(0xb8008a64,0x82008200);
	rtd_outl(0xb8008a68,0x13806008);
	rtd_outl(0xb8008a6c,0x4003ff61);

	rtd_outl(0xb8008a70,0x09840806);
	rtd_outl(0xb8008a74,0x78007800);
	rtd_outl(0xb8008a78,0x13806008);
	rtd_outl(0xb8008a7c,0x4003ff61);

	rtd_outl(0xb8008a80,0x09840800);
	rtd_outl(0xb8008a84,0x3c003c00);
	rtd_outl(0xb8008a88,0x7ff7ff08);
	rtd_outl(0xb8008a8c,0x00008031);

	rtd_outl(0xb8008a90,0x09840800);
	rtd_outl(0xb8008a94,0x32003200);
	rtd_outl(0xb8008a98,0x7ff7ff08);
	rtd_outl(0xb8008a9c,0x00008031);

	rtd_outl(0xb8008aa0,0x09840806);
	rtd_outl(0xb8008aa4,0x64006400);
	rtd_outl(0xb8008aa8,0x04002008);
	rtd_outl(0xb8008aac,0x40020061);
...
static int rtk_qos_load_mc_decoder_4k_jp_ddr4_setting(void)
{
	pr_debug("[QOS] DECODER 4K JP DDR4\n");
	...
	rtd_outl(0xb8008a24,0x00180630);
	rtd_outl(0xb8008a28,0x0000210e);
	rtd_outl(0xb8008a2c,0x001f0054);
	rtd_outl(0xb8008a30,0x000f0007);
	rtd_outl(0xb8008a34,0x03ff0000);
	rtd_outl(0xb8008a3c,0x00ffffff);
	...
	rtd_outl(0xb8008a44,0x6e006e00);
	rtd_outl(0xb8008a48,0x04002008);
	rtd_outl(0xb8008a4c,0x00020081);
	...
	rtd_outl(0xb8008a64,0x82008200);
	rtd_outl(0xb8008a68,0x13806008);
	rtd_outl(0xb8008a6c,0x0003ffa1);

	rtd_outl(0xb8008a70,0x09840806);
	rtd_outl(0xb8008a74,0x78007800);
	rtd_outl(0xb8008a78,0x13806008);
	rtd_outl(0xb8008a7c,0x0003ffa1);
	...
	rtd_outl(0xb8008aa4,0x64006400);
	rtd_outl(0xb8008aa8,0x04002008);
	rtd_outl(0xb8008aac,0x00020081);
...
static int rtk_qos_load_mc_decoder_2k_ddr4_setting(void)
{
	...
	rtd_outl(0xb8008a40,0x0984080c);
	rtd_outl(0xb8008a44,0x6e006e00);
	rtd_outl(0xb8008a48,0x10008008);
	rtd_outl(0xb8008a4c,0x00020051);

	rtd_outl(0xb8008a50,0x0984089c);
	rtd_outl(0xb8008a54,0x46004600);
	rtd_outl(0xb8008a58,0x7ff20008);
	rtd_outl(0xb8008a5c,0x00020051);

	rtd_outl(0xb8008a60,0x09840806);
	rtd_outl(0xb8008a64,0x82008200);
	rtd_outl(0xb8008a68,0x08004008);
	rtd_outl(0xb8008a6c,0x0003ffa1);

	rtd_outl(0xb8008a70,0x09840806);
	rtd_outl(0xb8008a74,0x78007800);
	rtd_outl(0xb8008a78,0x08004008);
	rtd_outl(0xb8008a7c,0x0003ffa1);
	...
	rtd_outl(0xb8008aa0,0x09840806);
	rtd_outl(0xb8008aa4,0x64006400);
	rtd_outl(0xb8008aa8,0x10008008);
	rtd_outl(0xb8008aac,0x00020051);
...
static int rtk_qos_decide_JP4K_mode(void)
{
#ifdef TP_API_READY_FOR_QOS
	if (RHAL_TP_IsJapan4K())
		return 1;
	else
#endif
		return 0;
...
//			{
			if (is_DDR4()) {
				if (rtk_qos_decide_JP4K_mode()) {
					rtk_qos_load_mc_decoder_4k_jp_ddr4_setting();
				} else {
					rtk_qos_load_mc_decoder_4k_ddr4_setting();
				}
			} else {
				if (rtk_qos_decide_JP4K_mode()) {
					rtk_qos_load_mc_decoder_4k_jp_setting();
				} else {
...
int rtk_qos_resume(void)
{
	...
	rtk_bw_limit_HW_set_threshold(RTK_BRIG_VE, 0x80, 0x200);
