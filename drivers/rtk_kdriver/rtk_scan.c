...
/**
   ...
   0xb8008EB8[31] => DM 主程式負責寫1，tool執行期間會清為0。藉此判斷DM是否有持續在執行
**/
...
#define CMDREG_INT_EN_REG 0xb801A114
#define CMDREG_INT_EN_BIT 1   //k->s interrupt enable

/* Module::sb2	Register::CPU_INT	Set::1	ATTR::nor	Type::SR	ADDR::0x1801_A104 */
#define CMDREG_INT_REG 0xb801A118
#define CMDREG_INT_BIT 1 //k-s   int
