#ifndef __RTK_SCD_ATR_H__
#define __RTK_SCD_ATR_H__
...
#define get_ta4(p_atr_info)        (p_atr_info->T4[0])
#define get_tb4(p_atr_info)        (p_atr_info->T4[1])
#define get_tc4(p_atr_info)        (p_atr_info->T4[2])
#define get_td4(p_atr_info)        (p_atr_info->T4[3])
...
#define has_ta4(p_atr_info)        (has_td3(p_atr_info) && (get_td3(p_atr_info) & 0x10))
#define has_tb4(p_atr_info)        (has_td3(p_atr_info) && (get_td3(p_atr_info) & 0x20))
#define has_tc4(p_atr_info)        (has_td3(p_atr_info) && (get_td3(p_atr_info) & 0x40))
#define has_td4(p_atr_info)        (has_td3(p_atr_info) && (get_td3(p_atr_info) & 0x80))s

#define ta1_f(p_atr_info)          ((get_ta1(p_atr_info)>>4)& 0xF)
#define ta1_d(p_atr_info)          (get_ta1(p_atr_info) & 0xF)
#define tb1_pi1(p_atr_info)        (get_tb1(p_atr_info) & 0x1F)
#define tb1_ii1(p_atr_info)        ((get_tb1(p_atr_info)>>5) & 0x3)
#define tc1_n(p_atr_info)          (get_tc1(p_atr_info) & 0xFF)
#define td1_protocol(p_atr_info)   (get_td1(p_atr_info) & 0xF)

#define ta2_ci(p_atr_info)         ((get_ta2(p_atr_info)>>7) & 0x1)
#define ta2_di(p_atr_info)         ((get_ta2(p_atr_info)>>4) & 0x1)
#define ta2_t(p_atr_info)          (get_ta2(p_atr_info) & 0xF)
#define tb2_pi1(p_atr_info)        (get_tb2(p_atr_info) & 0x1F)
#define tb2_ii1(p_atr_info)        ((get_tb2(p_atr_info)>>5) & 0x3)
#define tc2_wi(p_atr_info)         (get_tc2(p_atr_info) & 0xFF)
#define td2_protocol(p_atr_info)   (get_td2(p_atr_info) & 0xF)


#define ta3_ifsc(p_atr_info)       (get_ta3(p_atr_info) & 0xFF)
#define tb3_cwi(p_atr_info)        (get_tb3(p_atr_info) & 0x7)
#define tb3_bwi(p_atr_info)        ((get_tb3(p_atr_info)>>4) & 0x7)
#define tc3_edc(p_atr_info)        (get_tc3(p_atr_info)& 0x1)

#define sc_atr_protocol(atr_info) (has_td1(atr_info) ? td1_protocol(atr_info) : 0)
#define sc_atr_nigoation_mode(atr_info) ((has_ta2(atr_info) && ta2_ci(atr_info)) ? 0 : 1)
