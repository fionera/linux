...
static bool g_TimingModeChanged = false;
...
char Scaler_AVD_Open(void)
{
	...
	rtd_printk(KERN_INFO,TAG_NAME_AVD,"Scaler_Set_InputSrc()\n");
...
bool Scaler_AVD_SetChannelChange(void)
{
	...
	#endif
	rtd_printk(KERN_INFO, TAG_NAME_AVD,"#####Scaler_AVD_SetChannelChange start!\n");
	avd_good_timing_ready = FALSE;
...
bool Scaler_AVD_GetTimingModeChanged(void)
{
	return  g_TimingModeChanged;
}

void Scaler_AVD_SetTimingModeChanged(bool flag)
{
	g_TimingModeChanged = flag;
}
