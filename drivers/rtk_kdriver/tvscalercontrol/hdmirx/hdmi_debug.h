...
#define HDCP_FLOW_PRINTF(fmt, args...)       if(HDCP_FLOW_PRINT_FLAG)  rtd_printk(KERN_EMERG,  "[HDMI][HDCP][FLOW]", fmt, ##args)   
#define HDCP_INFO(fmt, args...)              rtd_printk(KERN_INFO,   "[HDMI][HDCP][INFO]", fmt, ##args)
#define HDCP_WARN(fmt, args...)              rtd_printk(KERN_EMERG,  "[HDMI][HDCP][WARN]", fmt, ##args)
...
#define AUDIO_FLOW_PRINTF(fmt, args...)      if(AUDIO_FLOW_PRINT_FLAG)  rtd_printk(KERN_EMERG,  "[HDMI][AUDIOF]", fmt, ##args)   
...
#define INFOFRAME_FLOW_PRINTF(fmt, args...)  if(INFOFRAME_FLOW_PRINT_FLAG) rtd_printk(KERN_EMERG,  "[HDMI][INFOF]", fmt, ##args)   
...
#define PWR_FLOW_PRINTF(fmt, args...)  if(PWR_FLOW_PRINT_FLAG) rtd_printk(KERN_NOTICE,  "[HDMI][PWR][DEBUG]", fmt, ##args) 
#define PWR_FLOW_INFO(fmt, args...)  if(PWR_FLOW_PRINT_FLAG) rtd_printk(KERN_INFO,  "[HDMI][PWR][INFO]", fmt, ##args) 
extern unsigned short g_pwr_print_cycle_cnt_thd;

#define PWR_EMG(fmt, args...)  rtd_printk(KERN_EMERG,  "[HDMI][PWR][WARN]", fmt, ##args) 
...
#define FRL_DBG(fmt, args...)  if(FRL_FLOW_PRINT_FLAG) rtd_printk(KERN_EMERG,  "[HDMI][HD21-FRL][DBG]", fmt, ##args)
#define FRL_INFO(fmt, args...)  if(FRL_FLOW_PRINT_FLAG) rtd_printk(KERN_EMERG,  "[HDMI][HD21-FRL][INFO]", fmt, ##args)
#define FRL_WARN(fmt, args...)  if(FRL_FLOW_PRINT_FLAG) rtd_printk(KERN_EMERG,  "[HDMI][HD21-FRL][WARN]", fmt, ##args)
...
#define HD21_DBG(fmt, args...)  if(HD21_FLOW_PRINT_FLAG) rtd_printk(KERN_EMERG,  "[HDMI][HD21][DBG]", fmt, ##args)
#define HD21_INFO(fmt, args...)  if(HD21_FLOW_PRINT_FLAG) rtd_printk(KERN_EMERG,  "[HDMI][HD21][INFO]", fmt, ##args)
#define HD21_WARN(fmt, args...)  if(HD21_FLOW_PRINT_FLAG) rtd_printk(KERN_EMERG,  "[HDMI][HD21][WARN]", fmt, ##args)
...
#define HDMI_OFMS_INFO(fmt, args...)              rtd_printk(KERN_INFO,   "[HDMI][OFMS][INFO]", fmt, ##args)
#define HDMI_OFMS_WARN(fmt, args...)              rtd_printk(KERN_EMERG,  "[HDMI][OFMS][WARN]", fmt, ##args)
