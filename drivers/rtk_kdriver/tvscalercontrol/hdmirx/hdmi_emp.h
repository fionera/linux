...
extern int lib_hdmi_set_em_hdr_config(unsigned char nport, EMP_PARAM* p_emp_cfg);
...
extern int lib_hdmi_set_em_vsem_type(unsigned char nport, unsigned char oui[3], unsigned short data_set_tag, unsigned char sync);
