...
//------------------------------------------------------------------------------
    ...
    #define HDMI_SCDC_DBG(fmt, args...)       rtd_printk(KERN_NOTICE, "[HDMI][SCDC][DBG]", fmt, ##args)
#else
    #define HDMI_SCDC_DBG(fmt, args...)
#endif

#define HDMI_SCDC_INFO(fmt, args...)          rtd_printk(KERN_INFO,   "[HDMI][SCDC][Info]", fmt, ##args)       
#define HDMI_SCDC_WARN(fmt, args...)          rtd_printk(KERN_EMERG,  "[HDMI][SCDC][WARN]", fmt, ##args) 
