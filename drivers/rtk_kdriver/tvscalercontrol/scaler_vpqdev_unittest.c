...
//						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_gVipSkipir_Islet, &gVipSkipir_Islet, sizeof(gVipSkipir_Islet));
						...
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_Local_Contrast_Table, (void*)&Local_Contrast_Table, sizeof(Local_Contrast_Table));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_LC_Backlight_Profile_Interpolation_table,(void*) &LC_Backlight_Profile_Interpolation_table, sizeof(LC_Backlight_Profile_Interpolation_table));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_LC_ToneMappingSlopePoint_Table, (void*)&LC_ToneMappingSlopePoint_Table, sizeof(LC_ToneMappingSlopePoint_Table));
						...
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_OD_table, (void*)&OD_table, sizeof(OD_table));
						VPQ_GenFile_setfile_data(vpq_file, &file_info[i], VPQUT_IOC_PQ_CMD_SET_OD_setting_table, (void*)&OD_setting_table, sizeof(OD_setting_table));
