...
/*uv half mid ctl0*/
	{
		...
		ptr->VipNewDDcti_uvhalfmid_ctl0.halfmid_en = dm_dcti_uvhalfmid_REG_0.halfmid_en;
		ptr->VipNewDDcti_uvhalfmid_ctl0.halfmid_consi_align_en = dm_dcti_uvhalfmid_REG_0.halfmid_consi_align_en;
		ptr->VipNewDDcti_uvhalfmid_ctl0.halfmid_filter_mode = dm_dcti_uvhalfmid_REG_0.halfmid_filter_mode;
		ptr->VipNewDDcti_uvhalfmid_ctl0.halfmid_hp_mode = dm_dcti_uvhalfmid_REG_0.halfmid_hp_mode;
		ptr->VipNewDDcti_uvhalfmid_ctl0.halfmid_th_coring = dm_dcti_uvhalfmid_REG_0.halfmid_th_coring;
		ptr->VipNewDDcti_uvhalfmid_ctl0.halfmid_steep_mode 	= dm_dcti_uvhalfmid_REG_0.halfmid_steep_mode;
		ptr->VipNewDDcti_uvhalfmid_ctl0.halfmid_th_steep = dm_dcti_uvhalfmid_REG_0.halfmid_th_steep;
		ptr->VipNewDDcti_uvhalfmid_ctl0.halfmid_rate_steep = dm_dcti_uvhalfmid_REG_0.halfmid_rate_steep;
	}
/*uv half mid ctl1*/
	{
		color_sharp_shp_dcti_uv_half_mid_ctrl_1_RBUS dm_dcti_uvhalfmid_REG_1;
		dm_dcti_uvhalfmid_REG_1.regValue = IoReg_Read32(COLOR_SHARP_SHP_DCTI_UV_HALF_MID_CTRL_1_reg);
		ptr->VipNewDDcti_uvhalfmid_ctl1.slopediff_maxmin_en = dm_dcti_uvhalfmid_REG_1.slopediff_maxmin_en;
		ptr->VipNewDDcti_uvhalfmid_ctl1.slopediff_fixlen = dm_dcti_uvhalfmid_REG_1.slopediff_fixlen;
		ptr->VipNewDDcti_uvhalfmid_ctl1.slopediff_mode = dm_dcti_uvhalfmid_REG_1.slopediff_mode;
		ptr->VipNewDDcti_uvhalfmid_ctl1.rate_slopediff_sum = dm_dcti_uvhalfmid_REG_1.rate_slopediff_sum;
		ptr->VipNewDDcti_uvhalfmid_ctl1.th_slopediff_sum = dm_dcti_uvhalfmid_REG_1.th_slopediff_sum;
		ptr->VipNewDDcti_uvhalfmid_ctl1.halfmid_psmth = dm_dcti_uvhalfmid_REG_1.halfmid_psmth;
	}
/*uv half mid ctl2*/
	{
		color_sharp_shp_dcti_uv_half_mid_ctrl_2_RBUS dm_dcti_uvhalfmid_REG_2;
		dm_dcti_uvhalfmid_REG_2.regValue = IoReg_Read32(COLOR_SHARP_SHP_DCTI_UV_HALF_MID_CTRL_2_reg);
		ptr->VipNewDDcti_uvhalfmid_ctl2.halfmid_blending = dm_dcti_uvhalfmid_REG_2.halfmid_blending;
		ptr->VipNewDDcti_uvhalfmid_ctl2.offs_enhance_val = dm_dcti_uvhalfmid_REG_2.offs_enhance_val;
		ptr->VipNewDDcti_uvhalfmid_ctl2.offs_enhance_bit = dm_dcti_uvhalfmid_REG_2.offs_enhance_bit;
		ptr->VipNewDDcti_uvhalfmid_ctl2.offs_enhance_mode = dm_dcti_uvhalfmid_REG_2.offs_enhance_mode;
		ptr->VipNewDDcti_uvhalfmid_ctl2.halfmid_rate_eng = dm_dcti_uvhalfmid_REG_2.halfmid_rate_eng;
		ptr->VipNewDDcti_uvhalfmid_ctl2.halfmid_th_eng = dm_dcti_uvhalfmid_REG_2.halfmid_th_eng;
	}
/*V ctl0*/
	{
		color_sharp_shp_v_dcti_ctrl_0_RBUS dm_v_dcti_REG_0;
...
unsigned char drvif_color_Gamma_Read_Write_Check(void)
{
	...
	timeout = timespec_to_timespec64(ns_to_timespec(500 * 1000));
#else
...
char drvif_color_D_3dLUT(unsigned char LUT_Ctrl, unsigned int *pArray)//flora@20150617
{
	...
	if (c3dlut_c3dlut_db_ctl_0_REG.db_en_0 == 1) {
		IoReg_SetBits(C3DLUT_C3DLUT_db_ctl_0_reg, C3DLUT_C3DLUT_db_ctl_0_db_apply_0_mask);		// DB apply
		rtd_printk(KERN_INFO, TAG_NAME, "drvif_color_D_3dLUT, disable 3D LUT, off line writing\n");
		/* wait for db apply*/
		timeoutcnt = 0x062500;
		do {
			c3dlut_c3dlut_db_ctl_0_REG.regValue = IoReg_Read32(C3DLUT_C3DLUT_db_ctl_0_reg);
		...
		if (timeoutcnt <= 10) {
			rtd_printk(KERN_EMERG, TAG_NAME, "drvif_color_D_3dLUT apply DB time out!\n");
			return -1;
		}
	}
	...
	for(B=0; B < 17 ; B++ )
		for( G=0; G < 17  ; G++)
		{
			...
			if (timeoutcnt<=10) {
				...
				IoReg_SetBits(C3DLUT_C3DLUT_db_ctl_0_reg, C3DLUT_C3DLUT_db_ctl_0_db_apply_0_mask);
				rtd_printk(KERN_EMERG, TAG_NAME, "drvif_color_D_3dLUT, table time out!\n");
				return -2;
			}
		}
...
void drvif_color_D_3dLUT_By_DMA(unsigned char LUT_Ctrl, unsigned int *pArray)
{
	...
	//rtd_printk(KERN_DEBUG, TAG_NAME, "3d lut phy_addr = %x,3dlut_virt = %x\n", address, pVirtAddr);
	...
	//	dvr_unmap_memory((void *)pVirtAddr, D_DOMAIN_3DLUT_BUFFER_SIZE);
		...
		rtd_printk(KERN_DEBUG, TAG_NAME, "PQ warning , drvif_color_D_3dLUT map virt memory fail!\n");
...
*/
	...
	if (!dma_phase_ok) {
		rtd_printk(KERN_DEBUG, TAG_NAME, "PQ warning, drvif_color_D_3dLUT_By_DMA result fail!\n");
	}
}
...
void drvif_color_D_3dLUT_By_DMA(unsigned char LUT_Ctrl, unsigned int *pArray, unsigned int addr, unsigned int* vir_addr)
{
	...
	//rtd_printk(KERN_INFO, TAG_NAME, "3d lut phy_addr = %x,3dlut_virt = %p,\n", addr, pVirtAddr);
...
short drvif_DD_DMA_Err_Check(unsigned char showMSG)
{
	...
	if (err_TBL[0]  != 0) {
		...
		if (showMSG == 1)
			rtd_printk(KERN_EMERG, TAG_NAME, "DMA_Err_Check, TBL0=%x\n", err_TBL[0]);
	}

	if (err_TBL[1]  != 0) {
		ret_val = ret_val | _BIT1;
		if (showMSG == 1)
			rtd_printk(KERN_EMERG, TAG_NAME, "DMA_Err_Check, TBL1=%x\n", err_TBL[1]);
	}
...
char drvif_DD_Wait_for_DMA_Apply_Done(void)
{
	...
	if (apply_done_check <= 0) {
		rtd_printk(KERN_EMERG, TAG_NAME, "DD DMA, Wait DMA finish fail\n");
		ret_val = -1;
	}
...
short drvif_DM2_EOTF_OETF_3DLUT_DMA_Err_Check(unsigned char showMSG)
{
	...
	if (err_TBL[0]  != 0) {
		ret_val = ret_val | _BIT0;
		if (showMSG == 1)
			rtd_printk(KERN_EMERG, TAG_NAME, "DMA_Err_Check, 0=%x\n", err_TBL[0]);
	}

	if (err_TBL[1]  != 0) {
		ret_val = ret_val | _BIT1;
		if (showMSG == 1)
			rtd_printk(KERN_EMERG, TAG_NAME, "DMA_Err_Check, 1=%x\n", err_TBL[1]);
	}

	if (err_TBL[2]  != 0) {
		ret_val = ret_val | _BIT2;
		if (showMSG == 1)
			rtd_printk(KERN_EMERG, TAG_NAME, "DMA_Err_Check, 2=%x\n", err_TBL[2]);
	}

	if (err_TBL[3]  != 0) {
		ret_val = ret_val | _BIT3;
		if (showMSG == 1)
			rtd_printk(KERN_EMERG, TAG_NAME, "DMA_Err_Check, 3=%x\n", err_TBL[3]);
	}

	if (err_TBL[4] != 0) {
		ret_val = ret_val | _BIT4;
		if (showMSG == 1)
			rtd_printk(KERN_EMERG, TAG_NAME, "DMA_Err_Check, 4=%x\n", err_TBL[4]);
	}

	if (err_TBL[5]  != 0) {
		ret_val = ret_val | _BIT5;
		if (showMSG == 1)
			rtd_printk(KERN_EMERG, TAG_NAME, "DMA_Err_Check, 5=%x\n", err_TBL[5]);
	}

	if (err_TBL[6] != 0) {
		ret_val = ret_val | _BIT6;
		if (showMSG == 1)
			rtd_printk(KERN_EMERG, TAG_NAME, "DMA_Err_Check, 6=%x\n", err_TBL[6]);
	...
	if (err_TBL[7]  != 0) {
		...
		if (showMSG == 1)
			rtd_printk(KERN_EMERG, TAG_NAME, "DMA_Err_Check, 7=%x\n", err_TBL[7]);
	}

	if (err_TBL[8]  != 0) {
		ret_val = ret_val | _BIT8;
		if (showMSG == 1)
			rtd_printk(KERN_EMERG, TAG_NAME, "DMA_Err_Check, 8=%x\n", err_TBL[8]);
	}

	if (err_TBL[9]  != 0) {
		ret_val = ret_val | _BIT9;
		if (showMSG == 1)
			rtd_printk(KERN_EMERG, TAG_NAME, "DMA_Err_Check, 9=%x\n", err_TBL[9]);
	}
...
char drvif_DM2_Wait_for_DMA_Apply_Done(void)
{
	...
	if (apply_done_check <= 0) {
		rtd_printk(KERN_EMERG, TAG_NAME, "DM2 DMA, Wait DMA finish fail\n");
		ret_val = -1;
	}
	return ret_val;
}
...
char drvif_DM2_EOTF_Set(unsigned int *EOTF_table32_R, unsigned int *EOTF_table32_G, unsigned int *EOTF_table32_B)
{
	...
	if (i >= (timeoutcnt_rw_addr-1)) {
		rtd_printk(KERN_EMERG, TAG_NAME, "PQ WARNING, Set HDR EOTF table wrong, rw_address not 0 ,times=%d",i);
		return -1;
	}
	...
	while(i < EOTF_size)
	{
		...
		if (timeoutcnt <= 10) {
			rtd_printk(KERN_EMERG, TAG_NAME, "PQ WARNING, EOTF Sram Timeout ,index=%d",i);
			return -1;
		}
...
char drvif_DM2_EOTF_Set_By_DMA(unsigned int *EOTF_table32_R, unsigned int *EOTF_table32_G, unsigned int *EOTF_table32_B, unsigned int addr, unsigned int* vir_addr)
{
	...
	if ((EOTF_table32_R == NULL) || (EOTF_table32_G == NULL) || (EOTF_table32_B == NULL) || (addr == 0) || (vir_addr == NULL)) {
		rtd_printk(KERN_EMERG, TAG_NAME, "drvif_DM2_OETF_Set_By_DMA, table NULL, R=%p, G=%p, B=%p, addr = %x, vi_addr = %p\n",
...
void drvif_DM2_EOTF_Get(unsigned int *EOTF_table32_R, unsigned int *EOTF_table32_G, unsigned int *EOTF_table32_B)
{
	...
	for(i=0;i<timeoutcnt_rw_addr;i++) //switch read/write , address will clean to 0 (some time not work)
	{
		...
		if(DM_HDR_EOTF_LUT_CTRL1_Reg.eotf_lut_rw_addr!=0)
			rtd_printk(KERN_EMERG, TAG_NAME, "PQ WARNING, Get HDR EOTF table wrong, rw_address not 0 ,times=%d",i);
		else
			break;
...
char drvif_DM2_OETF_Set(unsigned short *OETF_table16_R, unsigned short *OETF_table16_G, unsigned short *OETF_table16_B)
{
	...
	for(i=0;i<timeoutcnt_rw_addr;i++)//switch read/write , address will clean to 0 (some time not work)
	{
		...
		if(DM_HDR_OETF_LUT_CTRL1_Reg.oetf_lut_rw_addr!=0)
			;//rtd_printk(KERN_EMERG, TAG_NAME, "PQ WARNING, Set HDR OETF table wrong, rw_address not 0 ,times=%d",i);
		else
			break;
	} // read/write OE/EO table havt to check rw_address is 0
	...
	while(i < OETF_size)
	{
		...
		if (timeoutcnt <= 10) {
			rtd_printk(KERN_EMERG, TAG_NAME, "PQ WARNING, OETF Sram Timeout ,index=%d",i);
			return -1;
		}
...
void drvif_DM2_OETF_Set_Prog_Index( VIP_HDR_OETF_Prog_Idx_TBL* OETF_prog_idx_tbl )
{
	...
	for(i = 1; i<7; i++) // data check
	{
		if(OETF_prog_idx_tbl->oetf_grid_num_th[i] < OETF_prog_idx_tbl->oetf_grid_num_th[i-1])
			{rtd_printk(KERN_INFO, TAG_NAME, "PQ WARNING, HDR OETF table wrong, OETF_grid_num[%d] = %d > OETF_grid_num[%d] = %d\n", i - 1, OETF_prog_idx_tbl->oetf_grid_num_th[i - 1], i, OETF_prog_idx_tbl->oetf_grid_num_th[i]);}
	}
...
char drvif_DM2_OETF_Set_Prog_Index_th(unsigned int *OETF_Prog_Idx_th_TBL)
{
	...
	if (OETF_Prog_Idx_th_TBL == NULL) {
		rtd_printk(KERN_EMERG, TAG_NAME, "drvif_DM2_OETF_Set_Prog_Index, NULL TBL\n");
		return -1;
	}
...
void drvif_DM2_OETF_Get(unsigned short *OETF_table16_R, unsigned short *OETF_table16_G, unsigned short *OETF_table16_B)
{
	...
	for(i=0;i<timeoutcnt_rw_addr;i++)//switch read/write , address will clean to 0 (some time not work)
	{
		...
		if(DM_HDR_OETF_LUT_CTRL1_Reg.oetf_lut_rw_addr!=0)
			rtd_printk(KERN_EMERG, TAG_NAME, "PQ WARNING, Gt HDR OETF table wrong, rw_address not 0 ,times=%d",i);
		else
			break;
...
char drvif_Get_DM2_DB_Status(unsigned char *db_en, unsigned char *db_lv, unsigned char *db_apply)
{
	...
	if (db_en == NULL || db_lv == NULL || db_apply == NULL) {
		rtd_printk(KERN_EMERG, TAG_NAME, "drvif_Get_DM2_DB_Status, NULL point, db_en=%p, db_lv=%p, db_apply=%p,\n", db_en, db_lv, db_apply);
		return -1;
	}
...
char drvif_Get_DM2_OETF_Enable_Status(unsigned char *oetf_lut_enable, unsigned char *b0105_or_oetf, unsigned char *b02b03_no_sram_mode)
{
	...
	if (oetf_lut_enable == NULL || b0105_or_oetf == NULL || b02b03_no_sram_mode == NULL) {
		rtd_printk(KERN_EMERG, TAG_NAME, "drvif_Get_DM2_OETF_Enable_Status, NULL point, oetf_lut_enable=%p, b0105_or_oetf=%p, b02b03_no_sram_mode=%p,\n",
	...
	*b02b03_no_sram_mode = dm_hdr_path_sel_reg.b02b03_no_sram_mode;
...
char drvif_Get_DM2_EOTF_Enable_Status(unsigned char *eotf_lut_enable, unsigned char *b0103_or_eotf, unsigned char *b02b03_no_sram_mode)
{
	...
	if (eotf_lut_enable == NULL || b0103_or_eotf == NULL || b02b03_no_sram_mode == NULL) {
		rtd_printk(KERN_EMERG, TAG_NAME, "drvif_Get_DM2_EOTF_Enable_Status, NULL point, eotf_lut_enable=%p, b0103_or_eotf=%p, b02b03_no_sram_mode=%p,\n",
...
char drvif_Get_DM2_B05_Enable_Status(unsigned char *b05_En, unsigned char *dimension)
{
	...
	if (b05_En == NULL || dimension == NULL) {
		rtd_printk(KERN_EMERG, TAG_NAME, "drvif_Get_DM2_B05_Enable_Status, NULL point, b05_En=%p, dimension=%p,\n",
			b05_En, dimension);
		return -1;
	}
...
unsigned char drvif_Get_DM2_B0203_noSram_clk_flip_flop(void)
{
	...
	B0203_noSram = dm_hdr_path_sel_reg.b02b03_no_sram_mode;
...
char drvif_DM2_ToneMapping_Set(short *TM_table12_R, short *TM_table12_G, short *TM_table12_B)
{
	...
	while(i < ToneMapping_size)
	{
		...
		if (timeoutcnt <= 10) {
			rtd_printk(KERN_EMERG, TAG_NAME, "PQ WARNING, TM Sram Timeout ,index=%d",i);
			return -1;
		}
...
char drvif_DM2_ToneMapping_Set_By_DMA(short *TM12_R, short *TM12_G, short *TM12_B, unsigned int addr, unsigned int* vir_addr)
{
	...
	if ((TM12_R == NULL) || (TM12_G == NULL) || (TM12_B == NULL) || (addr == 0) || (vir_addr == NULL)) {
		rtd_printk(KERN_EMERG, TAG_NAME, "drvif_DM2_ToneMapping_Set_By_DMA, table NULL, R=%p, G=%p, B=%p, addr = %x, vi_addr = %p\n",
...
char drvif_DM2_HDR_histogram_Get_ISR(unsigned int *histogram_table24)
{
	...
	for (i = 0; i < HDR_Histogram_size; i = i + 4)
	{
		...
		if (timeoutcnt2 < 10)
		{
			...
			rtd_printk(KERN_EMERG, TAG_NAME, "HDR_histogram data lenth!t=%d,i=%d\n", timeoutcnt2, i);
...
char drvif_Get_VO_Active_Info(unsigned short *v_sta, unsigned short *v_end, unsigned short *line_cnt)
{
	...
	if ((v_sta == NULL) || (v_end == NULL) || (line_cnt == NULL)) {
		rtd_printk(KERN_EMERG, TAG_NAME, "drvif_Get_VO_Active_Info, NULL\n");
		return -1;
	}
...
char drvif_Wait_UZUDTG_start(short delay_st, short delay_end)
{
	...
	if (Bnd_1 <= Bnd_0) {
		rtd_printk(KERN_EMERG, TAG_NAME, "drvif_Wait_UZUDTG_start, check para, denST=%d, denEnd=%d, delay_st=%d, delay_end=%d\n",
	...
	if(timeoutcnt == 0){
	        rtd_printk(KERN_EMERG, TAG_NAME, "%s ERROR not wait the correct line \n", __FUNCTION__);
	}
	return -1;
}
...
char drvif_Get_UZUDTG_Info(unsigned short *v_sta, unsigned short *v_end, unsigned short *line_cnt)
{
	...
	if ((v_sta == NULL) || (v_end == NULL) || (line_cnt == NULL)) {
		rtd_printk(KERN_EMERG, TAG_NAME, "drvif_Get_UZUDTG_Info, NULL\n");
		return -1;
	}
...
char drvif_Wait_UZUDTG_END(short delay_st, short delay_end)
{
	...
	if (Bnd_1 <= Bnd_0) {
		rtd_printk(KERN_EMERG, TAG_NAME, "drvif_Wait_UZUDTG_END, check para, denST=%d, denEnd=%d, delay_st=%d, delay_end=%d\n",
			denST, denEnd, delay_st, delay_end);
		return -2;
	}
...
char drvif_Set_DM_HDR_3dLUT_24x24x24_16(unsigned char enable, unsigned short *pArray)
{
	...
	if (dm_double_buffer_ctrl_reg.dm_db_en == 1) {
		...
		if (timeoutcnt <= 10) {
			rtd_printk(KERN_EMERG, TAG_NAME, "PQ ERROR, 24x24x24 LUT apply time out!\n");
			return -1;
		}
	}
	...
	//timeoutcnt = 0x062500;
	timeoutcnt = 0x5000;
	//rtd_printk(KERN_EMERG, TAG_NAME, "debug1=%x,to=%d,\n", IoReg_Read32(0xB801B6B8), timeoutcnt);
	for (i = 0; i < 24; i++)
	{
		for(j = 0; j < 24; j++)
		{
	...
	//rtd_printk(KERN_EMERG, TAG_NAME, "debug2=%x,to=%d,\n", IoReg_Read32(0xB801B6B8), timeoutcnt);
	if (timeoutcnt <= 10)
	{
		rtd_printk(KERN_EMERG, TAG_NAME, "PQ, 24x24x24 LUT need write next time!\n");
		return -2;
	}
...
char drvif_Set_DM_HDR_3dLUT_24x24x24_16_By_DMA(unsigned char enable, unsigned short *pArray, unsigned int addr, unsigned int* vir_addr, unsigned int flush_size)
{
	...
	if ((pArray == NULL) || (addr == 0) || (vir_addr == NULL)) {
		rtd_printk(KERN_EMERG, TAG_NAME, "drvif_Set_DM_HDR_3dLUT_24x24x24_16_By_DMA, table NULL, pArray=%p, addr = %x, vi_addr = %p\n",
	...
	//rtd_printk(KERN_INFO, TAG_NAME, "HDR 3dlut : HDR 3dlut_phys %x , virtaddr %p \n",addr, vir_addr);
...
void drvif_HDR10_init(DRV_HDR10_submodule_CTL *pmoduleArray, DRV_HDR10_top_init_CTL *ptopArray)
{
	...
	threedlut_minmaxinv2_reg.regValue = IoReg_Read32(DM_ThreeDLUT_MinMaxInv2_reg);
	threedlut_minmaxinv3_reg.regValue = IoReg_Read32(DM_ThreeDLUT_MinMaxInv3_reg);
	dm_double_buffer_ctrl_reg.regValue = IoReg_Read32(DM_HDR_DM_Double_Buffer_CTRL_reg);
	...
	if ((pmoduleArray->HDR10_EN)==1)
	{
		...
		IoReg_Write32(DM_ThreeDLUT_MinMaxInv2_reg, threedlut_minmaxinv2_reg.regValue);
		IoReg_Write32(DM_ThreeDLUT_MinMaxInv3_reg, threedlut_minmaxinv3_reg.regValue);
		IoReg_Write32(DM_HDR_DM_Double_Buffer_CTRL_reg, dm_double_buffer_ctrl_reg.regValue);
		IoReg_Write32(DM_dm_submodule_enable_reg, dm_submodule_enable_reg.regValue);
		if(bInDolbyMode == FALSE) // dolby mode change by video fw
...
char WaitDOLBY_DB_Apply_Clean(void)
{
	...
	if (count <= 10) {
		rtd_printk(KERN_EMERG, TAG_NAME, "can not WaitDOLBY_DB_Apply_Clean\n");
		return -1;
	}
	return 0;
}
...
char WaitDM_DB_Apply_Clean(void)
{
	...
	if (count <= 10) {
		rtd_printk(KERN_EMERG, TAG_NAME, "can not WaitDM_DB_Apply_Clean\n");
				return -1;
	}
...
char drvif_color_set_DeMura(DRV_DeMura_DMA_TBL* pDMA_TBL, DRV_DeMura_CTRL_TBL *ptr, unsigned char *pArray, unsigned int addr, unsigned int *vir_addr, unsigned int TBL_Line_size)
{
	...
	if ((ptr == NULL) || (pArray == NULL) || (addr == 0) || (vir_addr == NULL)) {
		rtd_printk(KERN_INFO, TAG_NAME, "drvif_color_set_DeMura table NULL, ptr=%p,pArray=%p,addr=%x,vir_addr=%p\n", ptr, pArray, addr, vir_addr);
		return -1;
	}

	/* address setting*/ //
	//rtd_printk(KERN_INFO, TAG_NAME, "DeMura_MemStartAddr_phys = %x, DeMura_MemStartAddr_virt = %p\n", addr, vir_addr);
	...
	*/
	...
	demura_demura_keep_h_control0_reg.demura_r_h_keep_level= ptr->demura_r_h_keep_level;/*k6lp, add*/
	demura_demura_keep_h_control0_reg.demura_g_h_keep_level= ptr->demura_g_h_keep_level;/*k6lp, add*/
	demura_demura_keep_h_control1_reg.demura_b_h_keep_level = ptr->demura_b_h_keep_level;/*k6lp, add*/
	...
	IoReg_Write32(DEMURA_DEMURA_KEEP_H_CONTROL0_reg,demura_demura_keep_h_control0_reg.regValue);/*k6lp, add*/
	IoReg_Write32(DEMURA_DEMURA_KEEP_H_CONTROL1_reg,demura_demura_keep_h_control1_reg.regValue);/*k6lp, add*/
...
char drvif_color_Get_DeMura_CTRL(DRV_DeMura_CTRL_TBL *ptr)
{
	...
	if ((ptr == NULL)) {
		rtd_printk(KERN_INFO, TAG_NAME, "drvif_color_Get_DeMura_CTRL table NULL, ptr=%p,\n", ptr);
		return -1;
	}
...
{
	if(enable){
		IoReg_Mask32(0xb80996b0,~(_BIT0|_BIT1|_BIT2),(_BIT0)); //set to iz mode
