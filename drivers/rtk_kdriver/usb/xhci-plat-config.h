...
/////////////////////////////////////////////
// for all ports
// Updated: 2019/08/27 adjust: Z0, resister change to 4.7R
static U2_PHY_REGISTER u2_phy_setting[] =
{
    ...
    {1, 0xE0, 0x27},   // E0 Page 0 //Port1 set auto calibration 20190827 RS=4.7R 0x27
    {2, 0xE0, 0x27},
    ...
    {1, 0xE4, 0x8c},   // (second) bit[7:4] disconnt level,bit[3:0]=swing
    {2, 0xE4, 0x8a},
...
static U2_PHY_REGISTER u2_phy_setting_OLED[] =
{
    {1, 0xF4, 0xbb},   // zap to page1
    {2, 0xF4, 0xbb},
    ...
    {1, 0xE4, 0x6e},   // (first) bit[7:4] disconnt level, bit[3:0]=swing
    {2, 0xE4, 0x6a},
    ...
    {1, 0xE4, 0x8e},   // (second) bit[7:4] disconnt level,bit[3:0]=swing
    {2, 0xE4, 0x8a},
...
static __maybe_unused U2_PHY_CONFIG u2_phy_config_OLED= {
    .p_reg_table = u2_phy_setting_OLED,
    .n_reg       = sizeof(u2_phy_setting_OLED) / sizeof(U2_PHY_REGISTER),
};
