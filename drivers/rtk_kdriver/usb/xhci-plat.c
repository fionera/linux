...
static int xhci_usb2_phy_init(struct platform_device *pdev)
{
    ...
    {
        err = _usb2_load_phy_setting(xhci,
                            u2_phy_config_OLED.p_reg_table,
                            u2_phy_config_OLED.n_reg);
    }else{
        err = _usb2_load_phy_setting(xhci,
                            u2_phy_config.p_reg_table,
                            u2_phy_config.n_reg);
    }
...
static void init_usb3_phy_from_SD(void)
{
    ...
    //rtd_inl(0xb805a010);  //check CALIB_OK[6] need to check at P0 mode
    ScalerTimer_DelayXms(10);
...
static void init_usb2_phy_from_SD(void)
{
    ...
    /////// 0xF4_change Page1 //////
    rtd_outl(0xb805a014,0x0000bbbb);     //Select Page1//9b=page 0, bb=page 1,db=page 2(include DPLL)
...
void init_from_SD(void)
{
    ...
    //#include "write_XHCI_usb3_phy_Merlin5_parameter_V01.tbl"  //write XHCI USB 3.0 Phy register/include Pipe3 reset and release
    //#include "write_XHCI_usb3_phy_Merlin5_parameter_V01_RDC.tbl"    //write XHCI USB 3.0 Phy register/include Pipe3 reset and release
    init_usb3_phy_from_SD();

    /////////

    //////////////////////////after usb phy set and modify this usb 3.0 phy_Merlin5 new add 20190408//////////
