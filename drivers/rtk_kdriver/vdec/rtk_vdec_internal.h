...
#ifdef SUPPORT_SECURE_VERSION
#define RTKVDEC_MAX_VEPROT_MEM_NUM 10
#define RTKVDEC_VEPROT_BLOCK_SIZE 0x80000
#define RTKVDEC_MAX_VEPROT_DCU1_MEM_NUM 4
#define RTKVDEC_VEPROT_DCU1_BLOCK_SIZE 0x20000
#endif
...
typedef struct VDEC_VEPROT_DCU1_MEM_LIST {
	unsigned int used;
	unsigned long addr ;
	unsigned int size ;
} VDEC_VEPROT_DCU1_MEM_LIST;
#endif
