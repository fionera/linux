...
struct lg1k_usbphy {
	...
	int (*init)(struct lg1k_usbphy *lgphy);
};
...
extern int lg1k_usbphy_set_vbus(struct lg1k_usbphy *lgphy, int on);
extern int lg1k_usbphy_set_reset_ctl_mask(struct lg1k_usbphy *lgphy, int on);
extern void lg1k_usbphy_remove(struct lg1k_usbphy *lgphy);
extern int lg1k_usb_phy_set_type(struct usb_phy *phy, enum usb_phy_type type);
extern int lg1k_usb_phy_add(struct usb_phy *phy, struct device *dev,
