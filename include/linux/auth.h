...
#define CMA3_MAJOR		9
#define CMA3_NAME		"cma3 device"

#ifdef CONFIG_OPTEE_SUPPORT_MC_ALLOCATOR
#define MC_AUTH_MAJOR		10
#define MC_AUTH_NAME		"mc cma auth device"
#endif
...
#define DEF_MEM_SIZE		0x08000000    //PLI cache/non-cache region size
#define DEF_MAP_SIZE		0x10000000    //DEF_MAP_ADDR + DEF_MAP_SIZE = rbus mapping start 
...
#define AUTH_IOCQ_FREEPHYSADDR	 _IO(AUTH_IOC_MAGIC, 29)
#ifdef CONFIG_REALTEK_MANAGE_OVERLAPPED_REGION
