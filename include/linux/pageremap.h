...
#define GFP_DCU3	0x00000020
#ifdef CONFIG_OPTEE_SUPPORT_MC_ALLOCATOR
#define GFP_MC_CMA	0x00000040
#endif
...
#define DEF_CACHE_SIZE_LOW	8*1024*1024
...
#define pli_mc_malloc(id) pli_mc_malloc_mesg((id), __func__)
void pli_mc_free_mesg(enum remap_module_id module_id, const char *mesg);
#define pli_mc_free(id) pli_mc_free_mesg((id), __func__)
